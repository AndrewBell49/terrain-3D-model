		...
		<os:ElevationGridCoverage gml:id="os.t50.nj86.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nj86.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nj86.origin">
							<gml:pos>380000 860000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NJ86.asc</gml:fileReference><!-- URI -->

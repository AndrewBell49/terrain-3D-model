		...
		<os:ElevationGridCoverage gml:id="os.t50.nj85.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nj85.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nj85.origin">
							<gml:pos>380000 850000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NJ85.asc</gml:fileReference><!-- URI -->

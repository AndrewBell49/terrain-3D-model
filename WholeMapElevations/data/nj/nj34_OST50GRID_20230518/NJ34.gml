		...
		<os:ElevationGridCoverage gml:id="os.t50.nj34.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nj34.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nj34.origin">
							<gml:pos>330000 840000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NJ34.asc</gml:fileReference><!-- URI -->

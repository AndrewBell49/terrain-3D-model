		...
		<os:ElevationGridCoverage gml:id="os.t50.nj04.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nj04.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nj04.origin">
							<gml:pos>300000 840000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NJ04.asc</gml:fileReference><!-- URI -->

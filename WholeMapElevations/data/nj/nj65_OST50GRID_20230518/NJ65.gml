		...
		<os:ElevationGridCoverage gml:id="os.t50.nj65.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nj65.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nj65.origin">
							<gml:pos>360000 850000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NJ65.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nj01.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nj01.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nj01.origin">
							<gml:pos>300000 810000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NJ01.asc</gml:fileReference><!-- URI -->

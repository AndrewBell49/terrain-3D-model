		...
		<os:ElevationGridCoverage gml:id="os.t50.nj84.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nj84.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nj84.origin">
							<gml:pos>380000 840000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NJ84.asc</gml:fileReference><!-- URI -->

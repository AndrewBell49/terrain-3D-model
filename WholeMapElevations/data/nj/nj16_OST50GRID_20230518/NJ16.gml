		...
		<os:ElevationGridCoverage gml:id="os.t50.nj16.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nj16.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nj16.origin">
							<gml:pos>310000 860000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NJ16.asc</gml:fileReference><!-- URI -->

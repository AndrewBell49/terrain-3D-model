		...
		<os:ElevationGridCoverage gml:id="os.t50.nj10.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nj10.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nj10.origin">
							<gml:pos>310000 800000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NJ10.asc</gml:fileReference><!-- URI -->

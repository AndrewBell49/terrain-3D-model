		...
		<os:ElevationGridCoverage gml:id="os.t50.nj12.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nj12.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nj12.origin">
							<gml:pos>310000 820000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NJ12.asc</gml:fileReference><!-- URI -->

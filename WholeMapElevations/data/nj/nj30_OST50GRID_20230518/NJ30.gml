		...
		<os:ElevationGridCoverage gml:id="os.t50.nj30.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nj30.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nj30.origin">
							<gml:pos>330000 800000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NJ30.asc</gml:fileReference><!-- URI -->

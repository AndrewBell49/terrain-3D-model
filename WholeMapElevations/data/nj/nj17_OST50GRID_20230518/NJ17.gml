		...
		<os:ElevationGridCoverage gml:id="os.t50.nj17.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nj17.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nj17.origin">
							<gml:pos>310000 870000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NJ17.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nr27.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nr27.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nr27.origin">
							<gml:pos>120000 670000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NR27.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nr64.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nr64.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nr64.origin">
							<gml:pos>160000 640000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NR64.asc</gml:fileReference><!-- URI -->

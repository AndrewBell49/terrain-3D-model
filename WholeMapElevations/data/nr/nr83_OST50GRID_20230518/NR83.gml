		...
		<os:ElevationGridCoverage gml:id="os.t50.nr83.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nr83.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nr83.origin">
							<gml:pos>180000 630000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NR83.asc</gml:fileReference><!-- URI -->

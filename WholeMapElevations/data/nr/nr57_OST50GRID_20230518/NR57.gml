		...
		<os:ElevationGridCoverage gml:id="os.t50.nr57.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nr57.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nr57.origin">
							<gml:pos>150000 670000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NR57.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nr60.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nr60.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nr60.origin">
							<gml:pos>160000 600000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NR60.asc</gml:fileReference><!-- URI -->

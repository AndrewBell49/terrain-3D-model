		...
		<os:ElevationGridCoverage gml:id="os.t50.nr95.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nr95.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nr95.origin">
							<gml:pos>190000 650000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NR95.asc</gml:fileReference><!-- URI -->

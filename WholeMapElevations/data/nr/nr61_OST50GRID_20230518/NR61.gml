		...
		<os:ElevationGridCoverage gml:id="os.t50.nr61.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nr61.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nr61.origin">
							<gml:pos>160000 610000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NR61.asc</gml:fileReference><!-- URI -->

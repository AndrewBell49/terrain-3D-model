		...
		<os:ElevationGridCoverage gml:id="os.t50.nr96.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nr96.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nr96.origin">
							<gml:pos>190000 660000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NR96.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.ny87.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ny87.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ny87.origin">
							<gml:pos>380000 570000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NY87.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.ny89.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ny89.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ny89.origin">
							<gml:pos>380000 590000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NY89.asc</gml:fileReference><!-- URI -->

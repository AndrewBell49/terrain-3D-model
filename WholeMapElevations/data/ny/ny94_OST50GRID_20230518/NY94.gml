		...
		<os:ElevationGridCoverage gml:id="os.t50.ny94.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ny94.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ny94.origin">
							<gml:pos>390000 540000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NY94.asc</gml:fileReference><!-- URI -->

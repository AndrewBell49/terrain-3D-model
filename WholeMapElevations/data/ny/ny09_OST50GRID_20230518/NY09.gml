		...
		<os:ElevationGridCoverage gml:id="os.t50.ny09.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ny09.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ny09.origin">
							<gml:pos>300000 590000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NY09.asc</gml:fileReference><!-- URI -->

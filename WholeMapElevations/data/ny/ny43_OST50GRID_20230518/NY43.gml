		...
		<os:ElevationGridCoverage gml:id="os.t50.ny43.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ny43.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ny43.origin">
							<gml:pos>340000 530000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NY43.asc</gml:fileReference><!-- URI -->

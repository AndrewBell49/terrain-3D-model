		...
		<os:ElevationGridCoverage gml:id="os.t50.nh20.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nh20.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nh20.origin">
							<gml:pos>220000 800000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NH20.asc</gml:fileReference><!-- URI -->

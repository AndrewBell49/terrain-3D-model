		...
		<os:ElevationGridCoverage gml:id="os.t50.nh10.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nh10.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nh10.origin">
							<gml:pos>210000 800000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NH10.asc</gml:fileReference><!-- URI -->

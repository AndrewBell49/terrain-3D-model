		...
		<os:ElevationGridCoverage gml:id="os.t50.nh71.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nh71.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nh71.origin">
							<gml:pos>270000 810000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NH71.asc</gml:fileReference><!-- URI -->

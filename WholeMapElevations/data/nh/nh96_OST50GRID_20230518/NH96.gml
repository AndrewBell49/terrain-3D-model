		...
		<os:ElevationGridCoverage gml:id="os.t50.nh96.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nh96.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nh96.origin">
							<gml:pos>290000 860000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NH96.asc</gml:fileReference><!-- URI -->

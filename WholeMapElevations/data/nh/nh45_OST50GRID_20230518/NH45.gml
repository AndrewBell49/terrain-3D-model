		...
		<os:ElevationGridCoverage gml:id="os.t50.nh45.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nh45.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nh45.origin">
							<gml:pos>240000 850000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NH45.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nh39.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nh39.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nh39.origin">
							<gml:pos>230000 890000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NH39.asc</gml:fileReference><!-- URI -->

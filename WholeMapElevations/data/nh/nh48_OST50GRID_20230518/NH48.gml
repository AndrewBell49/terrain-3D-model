		...
		<os:ElevationGridCoverage gml:id="os.t50.nh48.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nh48.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nh48.origin">
							<gml:pos>240000 880000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NH48.asc</gml:fileReference><!-- URI -->

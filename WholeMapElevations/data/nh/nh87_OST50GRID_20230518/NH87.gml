		...
		<os:ElevationGridCoverage gml:id="os.t50.nh87.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nh87.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nh87.origin">
							<gml:pos>280000 870000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NH87.asc</gml:fileReference><!-- URI -->

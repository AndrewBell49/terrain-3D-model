		...
		<os:ElevationGridCoverage gml:id="os.t50.nh15.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nh15.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nh15.origin">
							<gml:pos>210000 850000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NH15.asc</gml:fileReference><!-- URI -->

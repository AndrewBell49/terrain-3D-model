		...
		<os:ElevationGridCoverage gml:id="os.t50.nh36.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nh36.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nh36.origin">
							<gml:pos>230000 860000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NH36.asc</gml:fileReference><!-- URI -->

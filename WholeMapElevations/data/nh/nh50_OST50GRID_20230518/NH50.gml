		...
		<os:ElevationGridCoverage gml:id="os.t50.nh50.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nh50.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nh50.origin">
							<gml:pos>250000 800000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NH50.asc</gml:fileReference><!-- URI -->

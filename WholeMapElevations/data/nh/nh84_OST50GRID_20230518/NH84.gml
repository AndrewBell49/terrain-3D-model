		...
		<os:ElevationGridCoverage gml:id="os.t50.nh84.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nh84.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nh84.origin">
							<gml:pos>280000 840000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NH84.asc</gml:fileReference><!-- URI -->

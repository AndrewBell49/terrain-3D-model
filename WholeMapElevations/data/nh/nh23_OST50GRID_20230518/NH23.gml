		...
		<os:ElevationGridCoverage gml:id="os.t50.nh23.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nh23.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nh23.origin">
							<gml:pos>220000 830000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NH23.asc</gml:fileReference><!-- URI -->

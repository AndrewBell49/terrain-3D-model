		...
		<os:ElevationGridCoverage gml:id="os.t50.ss10.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ss10.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ss10.origin">
							<gml:pos>210000 100000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SS10.asc</gml:fileReference><!-- URI -->

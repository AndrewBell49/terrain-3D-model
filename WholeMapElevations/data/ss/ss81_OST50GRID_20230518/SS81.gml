		...
		<os:ElevationGridCoverage gml:id="os.t50.ss81.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ss81.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ss81.origin">
							<gml:pos>280000 110000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SS81.asc</gml:fileReference><!-- URI -->

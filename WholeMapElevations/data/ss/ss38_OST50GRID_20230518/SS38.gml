		...
		<os:ElevationGridCoverage gml:id="os.t50.ss38.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ss38.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ss38.origin">
							<gml:pos>230000 180000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SS38.asc</gml:fileReference><!-- URI -->

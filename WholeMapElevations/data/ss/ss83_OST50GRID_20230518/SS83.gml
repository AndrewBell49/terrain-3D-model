		...
		<os:ElevationGridCoverage gml:id="os.t50.ss83.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ss83.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ss83.origin">
							<gml:pos>280000 130000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SS83.asc</gml:fileReference><!-- URI -->

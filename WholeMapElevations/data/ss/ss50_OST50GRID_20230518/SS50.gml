		...
		<os:ElevationGridCoverage gml:id="os.t50.ss50.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ss50.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ss50.origin">
							<gml:pos>250000 100000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SS50.asc</gml:fileReference><!-- URI -->

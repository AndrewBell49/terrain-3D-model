		...
		<os:ElevationGridCoverage gml:id="os.t50.ss48.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ss48.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ss48.origin">
							<gml:pos>240000 180000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SS48.asc</gml:fileReference><!-- URI -->

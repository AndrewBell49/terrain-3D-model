		...
		<os:ElevationGridCoverage gml:id="os.t50.ss98.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ss98.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ss98.origin">
							<gml:pos>290000 180000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SS98.asc</gml:fileReference><!-- URI -->

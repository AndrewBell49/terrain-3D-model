		...
		<os:ElevationGridCoverage gml:id="os.t50.ss92.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ss92.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ss92.origin">
							<gml:pos>290000 120000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SS92.asc</gml:fileReference><!-- URI -->

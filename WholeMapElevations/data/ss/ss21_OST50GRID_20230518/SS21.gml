		...
		<os:ElevationGridCoverage gml:id="os.t50.ss21.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ss21.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ss21.origin">
							<gml:pos>220000 110000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SS21.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.ss97.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ss97.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ss97.origin">
							<gml:pos>290000 170000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SS97.asc</gml:fileReference><!-- URI -->

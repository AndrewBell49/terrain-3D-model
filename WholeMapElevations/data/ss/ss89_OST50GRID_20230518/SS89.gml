		...
		<os:ElevationGridCoverage gml:id="os.t50.ss89.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ss89.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ss89.origin">
							<gml:pos>280000 190000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SS89.asc</gml:fileReference><!-- URI -->

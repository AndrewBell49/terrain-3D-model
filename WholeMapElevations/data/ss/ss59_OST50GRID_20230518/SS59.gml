		...
		<os:ElevationGridCoverage gml:id="os.t50.ss59.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ss59.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ss59.origin">
							<gml:pos>250000 190000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SS59.asc</gml:fileReference><!-- URI -->

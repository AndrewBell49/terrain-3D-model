		...
		<os:ElevationGridCoverage gml:id="os.t50.se99.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.se99.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.se99.origin">
							<gml:pos>490000 490000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SE99.asc</gml:fileReference><!-- URI -->

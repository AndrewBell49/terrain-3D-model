		...
		<os:ElevationGridCoverage gml:id="os.t50.se10.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.se10.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.se10.origin">
							<gml:pos>410000 400000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SE10.asc</gml:fileReference><!-- URI -->

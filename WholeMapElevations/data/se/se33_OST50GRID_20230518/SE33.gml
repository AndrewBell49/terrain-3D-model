		...
		<os:ElevationGridCoverage gml:id="os.t50.se33.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.se33.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.se33.origin">
							<gml:pos>430000 430000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SE33.asc</gml:fileReference><!-- URI -->

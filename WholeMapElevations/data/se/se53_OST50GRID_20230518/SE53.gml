		...
		<os:ElevationGridCoverage gml:id="os.t50.se53.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.se53.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.se53.origin">
							<gml:pos>450000 430000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SE53.asc</gml:fileReference><!-- URI -->

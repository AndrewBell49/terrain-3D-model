		...
		<os:ElevationGridCoverage gml:id="os.t50.se17.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.se17.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.se17.origin">
							<gml:pos>410000 470000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SE17.asc</gml:fileReference><!-- URI -->

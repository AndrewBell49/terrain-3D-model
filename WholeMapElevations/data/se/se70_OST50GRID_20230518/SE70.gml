		...
		<os:ElevationGridCoverage gml:id="os.t50.se70.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.se70.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.se70.origin">
							<gml:pos>470000 400000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SE70.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.se05.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.se05.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.se05.origin">
							<gml:pos>400000 450000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SE05.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.se93.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.se93.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.se93.origin">
							<gml:pos>490000 430000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SE93.asc</gml:fileReference><!-- URI -->

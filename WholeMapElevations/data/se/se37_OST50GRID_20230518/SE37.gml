		...
		<os:ElevationGridCoverage gml:id="os.t50.se37.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.se37.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.se37.origin">
							<gml:pos>430000 470000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SE37.asc</gml:fileReference><!-- URI -->

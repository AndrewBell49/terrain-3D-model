		...
		<os:ElevationGridCoverage gml:id="os.t50.se73.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.se73.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.se73.origin">
							<gml:pos>470000 430000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SE73.asc</gml:fileReference><!-- URI -->

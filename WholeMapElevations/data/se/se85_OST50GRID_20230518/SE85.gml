		...
		<os:ElevationGridCoverage gml:id="os.t50.se85.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.se85.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.se85.origin">
							<gml:pos>480000 450000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SE85.asc</gml:fileReference><!-- URI -->

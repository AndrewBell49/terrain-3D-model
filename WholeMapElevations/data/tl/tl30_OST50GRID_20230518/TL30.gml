		...
		<os:ElevationGridCoverage gml:id="os.t50.tl30.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tl30.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tl30.origin">
							<gml:pos>530000 200000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TL30.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tl14.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tl14.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tl14.origin">
							<gml:pos>510000 240000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TL14.asc</gml:fileReference><!-- URI -->

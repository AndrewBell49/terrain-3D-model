		...
		<os:ElevationGridCoverage gml:id="os.t50.tl09.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tl09.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tl09.origin">
							<gml:pos>500000 290000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TL09.asc</gml:fileReference><!-- URI -->

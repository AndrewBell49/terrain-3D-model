		...
		<os:ElevationGridCoverage gml:id="os.t50.tl48.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tl48.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tl48.origin">
							<gml:pos>540000 280000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TL48.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tl31.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tl31.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tl31.origin">
							<gml:pos>530000 210000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TL31.asc</gml:fileReference><!-- URI -->

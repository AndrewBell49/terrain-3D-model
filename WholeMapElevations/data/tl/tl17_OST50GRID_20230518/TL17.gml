		...
		<os:ElevationGridCoverage gml:id="os.t50.tl17.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tl17.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tl17.origin">
							<gml:pos>510000 270000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TL17.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tl84.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tl84.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tl84.origin">
							<gml:pos>580000 240000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TL84.asc</gml:fileReference><!-- URI -->

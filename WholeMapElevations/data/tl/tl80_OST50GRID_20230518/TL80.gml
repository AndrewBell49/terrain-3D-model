		...
		<os:ElevationGridCoverage gml:id="os.t50.tl80.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tl80.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tl80.origin">
							<gml:pos>580000 200000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TL80.asc</gml:fileReference><!-- URI -->

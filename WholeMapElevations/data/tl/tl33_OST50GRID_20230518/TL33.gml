		...
		<os:ElevationGridCoverage gml:id="os.t50.tl33.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tl33.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tl33.origin">
							<gml:pos>530000 230000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TL33.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tl52.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tl52.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tl52.origin">
							<gml:pos>550000 220000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TL52.asc</gml:fileReference><!-- URI -->

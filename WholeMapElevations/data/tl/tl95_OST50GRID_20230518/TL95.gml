		...
		<os:ElevationGridCoverage gml:id="os.t50.tl95.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tl95.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tl95.origin">
							<gml:pos>590000 250000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TL95.asc</gml:fileReference><!-- URI -->

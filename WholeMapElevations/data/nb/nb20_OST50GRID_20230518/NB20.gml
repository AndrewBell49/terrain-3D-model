		...
		<os:ElevationGridCoverage gml:id="os.t50.nb20.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nb20.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nb20.origin">
							<gml:pos>120000 900000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NB20.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nb31.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nb31.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nb31.origin">
							<gml:pos>130000 910000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NB31.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nb56.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nb56.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nb56.origin">
							<gml:pos>150000 960000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NB56.asc</gml:fileReference><!-- URI -->

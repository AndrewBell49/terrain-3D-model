		...
		<os:ElevationGridCoverage gml:id="os.t50.nb42.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nb42.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nb42.origin">
							<gml:pos>140000 920000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NB42.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nb90.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nb90.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nb90.origin">
							<gml:pos>190000 900000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NB90.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nb44.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nb44.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nb44.origin">
							<gml:pos>140000 940000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NB44.asc</gml:fileReference><!-- URI -->

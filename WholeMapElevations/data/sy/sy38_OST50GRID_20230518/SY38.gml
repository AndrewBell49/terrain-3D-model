		...
		<os:ElevationGridCoverage gml:id="os.t50.sy38.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sy38.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sy38.origin">
							<gml:pos>330000 80000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SY38.asc</gml:fileReference><!-- URI -->

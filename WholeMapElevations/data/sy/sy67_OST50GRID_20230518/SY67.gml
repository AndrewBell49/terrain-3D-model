		...
		<os:ElevationGridCoverage gml:id="os.t50.sy67.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sy67.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sy67.origin">
							<gml:pos>360000 70000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SY67.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sv80.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sv80.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sv80.origin">
							<gml:pos>80000 0</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SV80.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tm23.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tm23.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tm23.origin">
							<gml:pos>620000 230000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TM23.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tm15.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tm15.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tm15.origin">
							<gml:pos>610000 250000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TM15.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tm57.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tm57.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tm57.origin">
							<gml:pos>650000 270000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TM57.asc</gml:fileReference><!-- URI -->

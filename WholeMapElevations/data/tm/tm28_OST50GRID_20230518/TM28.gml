		...
		<os:ElevationGridCoverage gml:id="os.t50.tm28.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tm28.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tm28.origin">
							<gml:pos>620000 280000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TM28.asc</gml:fileReference><!-- URI -->

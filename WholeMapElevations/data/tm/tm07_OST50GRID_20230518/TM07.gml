		...
		<os:ElevationGridCoverage gml:id="os.t50.tm07.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tm07.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tm07.origin">
							<gml:pos>600000 270000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TM07.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sw84.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sw84.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sw84.origin">
							<gml:pos>180000 40000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SW84.asc</gml:fileReference><!-- URI -->

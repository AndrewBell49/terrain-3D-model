		...
		<os:ElevationGridCoverage gml:id="os.t50.sw98.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sw98.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sw98.origin">
							<gml:pos>190000 80000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SW98.asc</gml:fileReference><!-- URI -->

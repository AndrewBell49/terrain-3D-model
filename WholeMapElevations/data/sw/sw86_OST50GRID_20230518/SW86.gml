		...
		<os:ElevationGridCoverage gml:id="os.t50.sw86.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sw86.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sw86.origin">
							<gml:pos>180000 60000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SW86.asc</gml:fileReference><!-- URI -->

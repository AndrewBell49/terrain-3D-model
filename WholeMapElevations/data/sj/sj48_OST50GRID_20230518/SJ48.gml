		...
		<os:ElevationGridCoverage gml:id="os.t50.sj48.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj48.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj48.origin">
							<gml:pos>340000 380000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ48.asc</gml:fileReference><!-- URI -->

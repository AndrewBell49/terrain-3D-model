		...
		<os:ElevationGridCoverage gml:id="os.t50.sj19.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj19.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj19.origin">
							<gml:pos>310000 390000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ19.asc</gml:fileReference><!-- URI -->

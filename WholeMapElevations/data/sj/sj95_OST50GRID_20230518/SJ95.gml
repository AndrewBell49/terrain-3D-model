		...
		<os:ElevationGridCoverage gml:id="os.t50.sj95.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj95.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj95.origin">
							<gml:pos>390000 350000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ95.asc</gml:fileReference><!-- URI -->

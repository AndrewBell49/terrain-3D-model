		...
		<os:ElevationGridCoverage gml:id="os.t50.sj28.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj28.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj28.origin">
							<gml:pos>320000 380000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ28.asc</gml:fileReference><!-- URI -->

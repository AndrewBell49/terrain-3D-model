		...
		<os:ElevationGridCoverage gml:id="os.t50.sj00.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj00.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj00.origin">
							<gml:pos>300000 300000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ00.asc</gml:fileReference><!-- URI -->

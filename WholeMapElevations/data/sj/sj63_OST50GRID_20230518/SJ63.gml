		...
		<os:ElevationGridCoverage gml:id="os.t50.sj63.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj63.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj63.origin">
							<gml:pos>360000 330000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ63.asc</gml:fileReference><!-- URI -->

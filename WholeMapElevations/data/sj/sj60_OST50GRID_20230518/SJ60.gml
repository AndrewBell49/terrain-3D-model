		...
		<os:ElevationGridCoverage gml:id="os.t50.sj60.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj60.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj60.origin">
							<gml:pos>360000 300000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ60.asc</gml:fileReference><!-- URI -->

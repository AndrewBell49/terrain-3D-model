		...
		<os:ElevationGridCoverage gml:id="os.t50.sj66.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj66.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj66.origin">
							<gml:pos>360000 360000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ66.asc</gml:fileReference><!-- URI -->

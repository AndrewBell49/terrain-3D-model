		...
		<os:ElevationGridCoverage gml:id="os.t50.nm31.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm31.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm31.origin">
							<gml:pos>130000 710000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM31.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nm87.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm87.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm87.origin">
							<gml:pos>180000 770000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM87.asc</gml:fileReference><!-- URI -->

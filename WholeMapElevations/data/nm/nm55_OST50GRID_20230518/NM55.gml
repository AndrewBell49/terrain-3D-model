		...
		<os:ElevationGridCoverage gml:id="os.t50.nm55.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm55.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm55.origin">
							<gml:pos>150000 750000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM55.asc</gml:fileReference><!-- URI -->

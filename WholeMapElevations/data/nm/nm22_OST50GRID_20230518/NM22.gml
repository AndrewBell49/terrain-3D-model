		...
		<os:ElevationGridCoverage gml:id="os.t50.nm22.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm22.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm22.origin">
							<gml:pos>120000 720000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM22.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nm66.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm66.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm66.origin">
							<gml:pos>160000 760000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM66.asc</gml:fileReference><!-- URI -->

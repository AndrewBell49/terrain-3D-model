		...
		<os:ElevationGridCoverage gml:id="os.t50.nm76.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm76.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm76.origin">
							<gml:pos>170000 760000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM76.asc</gml:fileReference><!-- URI -->

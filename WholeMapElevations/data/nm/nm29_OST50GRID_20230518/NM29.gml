		...
		<os:ElevationGridCoverage gml:id="os.t50.nm29.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm29.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm29.origin">
							<gml:pos>120000 790000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM29.asc</gml:fileReference><!-- URI -->

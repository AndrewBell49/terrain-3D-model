		...
		<os:ElevationGridCoverage gml:id="os.t50.nm25.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm25.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm25.origin">
							<gml:pos>120000 750000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM25.asc</gml:fileReference><!-- URI -->

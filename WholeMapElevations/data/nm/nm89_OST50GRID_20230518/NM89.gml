		...
		<os:ElevationGridCoverage gml:id="os.t50.nm89.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm89.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm89.origin">
							<gml:pos>180000 790000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM89.asc</gml:fileReference><!-- URI -->

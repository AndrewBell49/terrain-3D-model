		...
		<os:ElevationGridCoverage gml:id="os.t50.nm23.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm23.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm23.origin">
							<gml:pos>120000 730000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM23.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nm80.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm80.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm80.origin">
							<gml:pos>180000 700000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM80.asc</gml:fileReference><!-- URI -->

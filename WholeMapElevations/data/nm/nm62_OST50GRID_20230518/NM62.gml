		...
		<os:ElevationGridCoverage gml:id="os.t50.nm62.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm62.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm62.origin">
							<gml:pos>160000 720000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM62.asc</gml:fileReference><!-- URI -->

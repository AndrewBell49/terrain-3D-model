		...
		<os:ElevationGridCoverage gml:id="os.t50.nm04.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm04.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm04.origin">
							<gml:pos>100000 740000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM04.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nd02.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nd02.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nd02.origin">
							<gml:pos>300000 920000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ND02.asc</gml:fileReference><!-- URI -->

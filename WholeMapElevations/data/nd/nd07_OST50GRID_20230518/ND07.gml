		...
		<os:ElevationGridCoverage gml:id="os.t50.nd07.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nd07.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nd07.origin">
							<gml:pos>300000 970000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ND07.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nd19.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nd19.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nd19.origin">
							<gml:pos>310000 990000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ND19.asc</gml:fileReference><!-- URI -->

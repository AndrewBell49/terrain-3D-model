		...
		<os:ElevationGridCoverage gml:id="os.t50.nk13.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nk13.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nk13.origin">
							<gml:pos>410000 830000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NK13.asc</gml:fileReference><!-- URI -->

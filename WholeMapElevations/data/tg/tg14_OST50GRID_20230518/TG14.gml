		...
		<os:ElevationGridCoverage gml:id="os.t50.tg14.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tg14.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tg14.origin">
							<gml:pos>610000 340000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TG14.asc</gml:fileReference><!-- URI -->

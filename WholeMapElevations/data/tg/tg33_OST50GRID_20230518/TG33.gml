		...
		<os:ElevationGridCoverage gml:id="os.t50.tg33.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tg33.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tg33.origin">
							<gml:pos>630000 330000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TG33.asc</gml:fileReference><!-- URI -->

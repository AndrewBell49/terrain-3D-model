		...
		<os:ElevationGridCoverage gml:id="os.t50.tv59.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tv59.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tv59.origin">
							<gml:pos>550000 90000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TV59.asc</gml:fileReference><!-- URI -->

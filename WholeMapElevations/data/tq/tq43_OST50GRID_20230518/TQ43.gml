		...
		<os:ElevationGridCoverage gml:id="os.t50.tq43.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq43.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq43.origin">
							<gml:pos>540000 130000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ43.asc</gml:fileReference><!-- URI -->

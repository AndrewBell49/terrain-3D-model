		...
		<os:ElevationGridCoverage gml:id="os.t50.tq18.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq18.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq18.origin">
							<gml:pos>510000 180000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ18.asc</gml:fileReference><!-- URI -->

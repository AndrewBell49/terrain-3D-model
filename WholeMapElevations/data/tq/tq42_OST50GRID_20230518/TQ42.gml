		...
		<os:ElevationGridCoverage gml:id="os.t50.tq42.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq42.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq42.origin">
							<gml:pos>540000 120000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ42.asc</gml:fileReference><!-- URI -->

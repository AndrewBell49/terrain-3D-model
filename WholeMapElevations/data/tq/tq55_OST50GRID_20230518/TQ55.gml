		...
		<os:ElevationGridCoverage gml:id="os.t50.tq55.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq55.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq55.origin">
							<gml:pos>550000 150000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ55.asc</gml:fileReference><!-- URI -->

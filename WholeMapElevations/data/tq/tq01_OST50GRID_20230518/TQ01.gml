		...
		<os:ElevationGridCoverage gml:id="os.t50.tq01.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq01.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq01.origin">
							<gml:pos>500000 110000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ01.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tq27.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq27.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq27.origin">
							<gml:pos>520000 170000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ27.asc</gml:fileReference><!-- URI -->

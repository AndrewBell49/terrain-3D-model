		...
		<os:ElevationGridCoverage gml:id="os.t50.tq03.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq03.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq03.origin">
							<gml:pos>500000 130000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ03.asc</gml:fileReference><!-- URI -->

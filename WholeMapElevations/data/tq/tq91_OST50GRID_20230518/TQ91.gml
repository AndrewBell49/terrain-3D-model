		...
		<os:ElevationGridCoverage gml:id="os.t50.tq91.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq91.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq91.origin">
							<gml:pos>590000 110000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ91.asc</gml:fileReference><!-- URI -->

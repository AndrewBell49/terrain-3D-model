		...
		<os:ElevationGridCoverage gml:id="os.t50.tq59.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq59.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq59.origin">
							<gml:pos>550000 190000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ59.asc</gml:fileReference><!-- URI -->

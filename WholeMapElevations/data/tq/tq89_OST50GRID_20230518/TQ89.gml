		...
		<os:ElevationGridCoverage gml:id="os.t50.tq89.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq89.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq89.origin">
							<gml:pos>580000 190000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ89.asc</gml:fileReference><!-- URI -->

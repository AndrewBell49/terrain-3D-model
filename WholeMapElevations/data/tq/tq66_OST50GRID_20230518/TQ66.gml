		...
		<os:ElevationGridCoverage gml:id="os.t50.tq66.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq66.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq66.origin">
							<gml:pos>560000 160000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ66.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tq11.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq11.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq11.origin">
							<gml:pos>510000 110000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ11.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tq10.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq10.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq10.origin">
							<gml:pos>510000 100000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ10.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tq23.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq23.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq23.origin">
							<gml:pos>520000 130000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ23.asc</gml:fileReference><!-- URI -->

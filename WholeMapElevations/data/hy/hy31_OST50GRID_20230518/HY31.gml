		...
		<os:ElevationGridCoverage gml:id="os.t50.hy31.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hy31.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hy31.origin">
							<gml:pos>330000 1010000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HY31.asc</gml:fileReference><!-- URI -->

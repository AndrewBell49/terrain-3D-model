		...
		<os:ElevationGridCoverage gml:id="os.t50.hy63.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hy63.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hy63.origin">
							<gml:pos>360000 1030000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HY63.asc</gml:fileReference><!-- URI -->

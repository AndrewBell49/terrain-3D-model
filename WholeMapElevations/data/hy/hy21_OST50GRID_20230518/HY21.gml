		...
		<os:ElevationGridCoverage gml:id="os.t50.hy21.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hy21.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hy21.origin">
							<gml:pos>320000 1010000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HY21.asc</gml:fileReference><!-- URI -->

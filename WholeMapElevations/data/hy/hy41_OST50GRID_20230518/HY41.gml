		...
		<os:ElevationGridCoverage gml:id="os.t50.hy41.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hy41.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hy41.origin">
							<gml:pos>340000 1010000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HY41.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.hy74.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hy74.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hy74.origin">
							<gml:pos>370000 1040000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HY74.asc</gml:fileReference><!-- URI -->

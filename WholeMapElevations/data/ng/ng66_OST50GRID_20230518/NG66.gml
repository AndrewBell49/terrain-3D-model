		...
		<os:ElevationGridCoverage gml:id="os.t50.ng66.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ng66.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ng66.origin">
							<gml:pos>160000 860000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NG66.asc</gml:fileReference><!-- URI -->

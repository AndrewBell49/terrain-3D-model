		...
		<os:ElevationGridCoverage gml:id="os.t50.ng85.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ng85.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ng85.origin">
							<gml:pos>180000 850000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NG85.asc</gml:fileReference><!-- URI -->

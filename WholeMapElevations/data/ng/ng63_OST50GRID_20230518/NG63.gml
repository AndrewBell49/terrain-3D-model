		...
		<os:ElevationGridCoverage gml:id="os.t50.ng63.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ng63.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ng63.origin">
							<gml:pos>160000 830000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NG63.asc</gml:fileReference><!-- URI -->

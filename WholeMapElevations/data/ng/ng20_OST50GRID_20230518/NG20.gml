		...
		<os:ElevationGridCoverage gml:id="os.t50.ng20.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ng20.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ng20.origin">
							<gml:pos>120000 800000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NG20.asc</gml:fileReference><!-- URI -->

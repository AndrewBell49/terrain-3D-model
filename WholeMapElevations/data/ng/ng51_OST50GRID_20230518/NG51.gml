		...
		<os:ElevationGridCoverage gml:id="os.t50.ng51.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ng51.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ng51.origin">
							<gml:pos>150000 810000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NG51.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nn07.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nn07.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nn07.origin">
							<gml:pos>200000 770000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NN07.asc</gml:fileReference><!-- URI -->

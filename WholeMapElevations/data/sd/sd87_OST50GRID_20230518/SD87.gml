		...
		<os:ElevationGridCoverage gml:id="os.t50.sd87.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd87.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd87.origin">
							<gml:pos>380000 470000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD87.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sd08.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd08.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd08.origin">
							<gml:pos>300000 480000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD08.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sd46.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd46.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd46.origin">
							<gml:pos>340000 460000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD46.asc</gml:fileReference><!-- URI -->

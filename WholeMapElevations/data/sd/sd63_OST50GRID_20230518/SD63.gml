		...
		<os:ElevationGridCoverage gml:id="os.t50.sd63.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd63.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd63.origin">
							<gml:pos>360000 430000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD63.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sd17.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd17.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd17.origin">
							<gml:pos>310000 470000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD17.asc</gml:fileReference><!-- URI -->

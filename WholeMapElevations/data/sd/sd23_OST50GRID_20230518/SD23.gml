		...
		<os:ElevationGridCoverage gml:id="os.t50.sd23.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd23.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd23.origin">
							<gml:pos>320000 430000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD23.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sd85.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd85.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd85.origin">
							<gml:pos>380000 450000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD85.asc</gml:fileReference><!-- URI -->

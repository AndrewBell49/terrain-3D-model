		...
		<os:ElevationGridCoverage gml:id="os.t50.sd90.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd90.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd90.origin">
							<gml:pos>390000 400000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD90.asc</gml:fileReference><!-- URI -->

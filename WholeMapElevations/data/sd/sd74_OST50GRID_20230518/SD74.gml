		...
		<os:ElevationGridCoverage gml:id="os.t50.sd74.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd74.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd74.origin">
							<gml:pos>370000 440000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD74.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sd43.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd43.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd43.origin">
							<gml:pos>340000 430000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD43.asc</gml:fileReference><!-- URI -->

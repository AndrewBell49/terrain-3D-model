		...
		<os:ElevationGridCoverage gml:id="os.t50.sd35.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd35.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd35.origin">
							<gml:pos>330000 450000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD35.asc</gml:fileReference><!-- URI -->

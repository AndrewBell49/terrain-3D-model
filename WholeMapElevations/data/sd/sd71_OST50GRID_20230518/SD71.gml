		...
		<os:ElevationGridCoverage gml:id="os.t50.sd71.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd71.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd71.origin">
							<gml:pos>370000 410000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD71.asc</gml:fileReference><!-- URI -->

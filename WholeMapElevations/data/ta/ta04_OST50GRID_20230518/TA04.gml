		...
		<os:ElevationGridCoverage gml:id="os.t50.ta04.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ta04.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ta04.origin">
							<gml:pos>500000 440000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TA04.asc</gml:fileReference><!-- URI -->

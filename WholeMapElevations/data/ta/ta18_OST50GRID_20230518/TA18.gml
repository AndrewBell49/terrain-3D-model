		...
		<os:ElevationGridCoverage gml:id="os.t50.ta18.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ta18.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ta18.origin">
							<gml:pos>510000 480000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TA18.asc</gml:fileReference><!-- URI -->

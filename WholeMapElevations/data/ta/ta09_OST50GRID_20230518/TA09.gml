		...
		<os:ElevationGridCoverage gml:id="os.t50.ta09.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ta09.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ta09.origin">
							<gml:pos>500000 490000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TA09.asc</gml:fileReference><!-- URI -->

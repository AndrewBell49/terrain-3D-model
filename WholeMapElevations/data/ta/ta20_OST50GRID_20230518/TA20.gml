		...
		<os:ElevationGridCoverage gml:id="os.t50.ta20.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ta20.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ta20.origin">
							<gml:pos>520000 400000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TA20.asc</gml:fileReference><!-- URI -->

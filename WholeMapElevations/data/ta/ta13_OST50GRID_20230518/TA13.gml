		...
		<os:ElevationGridCoverage gml:id="os.t50.ta13.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ta13.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ta13.origin">
							<gml:pos>510000 430000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TA13.asc</gml:fileReference><!-- URI -->

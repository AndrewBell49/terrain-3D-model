		...
		<os:ElevationGridCoverage gml:id="os.t50.ta22.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ta22.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ta22.origin">
							<gml:pos>520000 420000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TA22.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sk19.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sk19.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sk19.origin">
							<gml:pos>410000 390000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SK19.asc</gml:fileReference><!-- URI -->

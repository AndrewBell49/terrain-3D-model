		...
		<os:ElevationGridCoverage gml:id="os.t50.sk21.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sk21.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sk21.origin">
							<gml:pos>420000 310000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SK21.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sk08.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sk08.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sk08.origin">
							<gml:pos>400000 380000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SK08.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sk76.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sk76.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sk76.origin">
							<gml:pos>470000 360000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SK76.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sk81.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sk81.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sk81.origin">
							<gml:pos>480000 310000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SK81.asc</gml:fileReference><!-- URI -->

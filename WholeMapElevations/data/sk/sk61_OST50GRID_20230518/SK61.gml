		...
		<os:ElevationGridCoverage gml:id="os.t50.sk61.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sk61.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sk61.origin">
							<gml:pos>460000 310000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SK61.asc</gml:fileReference><!-- URI -->

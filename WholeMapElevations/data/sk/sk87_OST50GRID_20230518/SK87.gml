		...
		<os:ElevationGridCoverage gml:id="os.t50.sk87.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sk87.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sk87.origin">
							<gml:pos>480000 370000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SK87.asc</gml:fileReference><!-- URI -->

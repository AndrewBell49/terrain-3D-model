		...
		<os:ElevationGridCoverage gml:id="os.t50.sk46.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sk46.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sk46.origin">
							<gml:pos>440000 360000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SK46.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sk98.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sk98.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sk98.origin">
							<gml:pos>490000 380000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SK98.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sk62.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sk62.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sk62.origin">
							<gml:pos>460000 320000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SK62.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sk71.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sk71.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sk71.origin">
							<gml:pos>470000 310000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SK71.asc</gml:fileReference><!-- URI -->

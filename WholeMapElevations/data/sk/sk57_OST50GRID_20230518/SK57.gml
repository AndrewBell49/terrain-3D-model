		...
		<os:ElevationGridCoverage gml:id="os.t50.sk57.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sk57.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sk57.origin">
							<gml:pos>450000 370000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SK57.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sk83.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sk83.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sk83.origin">
							<gml:pos>480000 330000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SK83.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.no19.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.no19.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.no19.origin">
							<gml:pos>310000 790000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NO19.asc</gml:fileReference><!-- URI -->

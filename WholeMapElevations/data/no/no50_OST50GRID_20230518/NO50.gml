		...
		<os:ElevationGridCoverage gml:id="os.t50.no50.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.no50.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.no50.origin">
							<gml:pos>350000 700000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NO50.asc</gml:fileReference><!-- URI -->

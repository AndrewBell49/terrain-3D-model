		...
		<os:ElevationGridCoverage gml:id="os.t50.no56.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.no56.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.no56.origin">
							<gml:pos>350000 760000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NO56.asc</gml:fileReference><!-- URI -->

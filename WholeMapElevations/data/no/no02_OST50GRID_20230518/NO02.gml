		...
		<os:ElevationGridCoverage gml:id="os.t50.no02.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.no02.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.no02.origin">
							<gml:pos>300000 720000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NO02.asc</gml:fileReference><!-- URI -->

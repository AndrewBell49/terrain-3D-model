		...
		<os:ElevationGridCoverage gml:id="os.t50.no78.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.no78.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.no78.origin">
							<gml:pos>370000 780000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NO78.asc</gml:fileReference><!-- URI -->

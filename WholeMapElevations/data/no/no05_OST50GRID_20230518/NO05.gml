		...
		<os:ElevationGridCoverage gml:id="os.t50.no05.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.no05.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.no05.origin">
							<gml:pos>300000 750000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NO05.asc</gml:fileReference><!-- URI -->

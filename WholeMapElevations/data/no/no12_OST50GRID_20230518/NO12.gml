		...
		<os:ElevationGridCoverage gml:id="os.t50.no12.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.no12.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.no12.origin">
							<gml:pos>310000 720000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NO12.asc</gml:fileReference><!-- URI -->

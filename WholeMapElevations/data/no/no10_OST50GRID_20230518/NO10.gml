		...
		<os:ElevationGridCoverage gml:id="os.t50.no10.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.no10.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.no10.origin">
							<gml:pos>310000 700000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NO10.asc</gml:fileReference><!-- URI -->

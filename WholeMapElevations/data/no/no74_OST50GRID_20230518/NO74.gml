		...
		<os:ElevationGridCoverage gml:id="os.t50.no74.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.no74.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.no74.origin">
							<gml:pos>370000 740000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NO74.asc</gml:fileReference><!-- URI -->

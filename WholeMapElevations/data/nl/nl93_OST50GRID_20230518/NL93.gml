		...
		<os:ElevationGridCoverage gml:id="os.t50.nl93.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nl93.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nl93.origin">
							<gml:pos>90000 730000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NL93.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sm40.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sm40.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sm40.origin">
							<gml:pos>140000 200000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SM40.asc</gml:fileReference><!-- URI -->

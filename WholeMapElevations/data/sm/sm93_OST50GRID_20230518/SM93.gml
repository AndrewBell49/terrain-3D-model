		...
		<os:ElevationGridCoverage gml:id="os.t50.sm93.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sm93.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sm93.origin">
							<gml:pos>190000 230000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SM93.asc</gml:fileReference><!-- URI -->

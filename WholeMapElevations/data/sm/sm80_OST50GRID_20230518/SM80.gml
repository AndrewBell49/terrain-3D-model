		...
		<os:ElevationGridCoverage gml:id="os.t50.sm80.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sm80.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sm80.origin">
							<gml:pos>180000 200000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SM80.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sm92.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sm92.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sm92.origin">
							<gml:pos>190000 220000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SM92.asc</gml:fileReference><!-- URI -->

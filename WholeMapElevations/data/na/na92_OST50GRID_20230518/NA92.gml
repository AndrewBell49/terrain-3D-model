		...
		<os:ElevationGridCoverage gml:id="os.t50.na92.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.na92.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.na92.origin">
							<gml:pos>90000 920000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NA92.asc</gml:fileReference><!-- URI -->

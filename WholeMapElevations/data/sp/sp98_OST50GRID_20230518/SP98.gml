		...
		<os:ElevationGridCoverage gml:id="os.t50.sp98.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sp98.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sp98.origin">
							<gml:pos>490000 280000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SP98.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sp30.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sp30.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sp30.origin">
							<gml:pos>430000 200000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SP30.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sp72.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sp72.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sp72.origin">
							<gml:pos>470000 220000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SP72.asc</gml:fileReference><!-- URI -->

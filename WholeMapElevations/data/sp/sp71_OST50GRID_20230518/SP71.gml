		...
		<os:ElevationGridCoverage gml:id="os.t50.sp71.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sp71.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sp71.origin">
							<gml:pos>470000 210000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SP71.asc</gml:fileReference><!-- URI -->

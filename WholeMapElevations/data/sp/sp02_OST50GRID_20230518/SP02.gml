		...
		<os:ElevationGridCoverage gml:id="os.t50.sp02.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sp02.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sp02.origin">
							<gml:pos>400000 220000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SP02.asc</gml:fileReference><!-- URI -->

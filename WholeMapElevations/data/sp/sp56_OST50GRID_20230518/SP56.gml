		...
		<os:ElevationGridCoverage gml:id="os.t50.sp56.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sp56.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sp56.origin">
							<gml:pos>450000 260000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SP56.asc</gml:fileReference><!-- URI -->

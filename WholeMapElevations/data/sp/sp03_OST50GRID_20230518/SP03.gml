		...
		<os:ElevationGridCoverage gml:id="os.t50.sp03.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sp03.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sp03.origin">
							<gml:pos>400000 230000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SP03.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sp47.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sp47.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sp47.origin">
							<gml:pos>440000 270000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SP47.asc</gml:fileReference><!-- URI -->

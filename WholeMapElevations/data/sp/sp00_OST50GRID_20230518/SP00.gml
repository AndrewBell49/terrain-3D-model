		...
		<os:ElevationGridCoverage gml:id="os.t50.sp00.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sp00.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sp00.origin">
							<gml:pos>400000 200000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SP00.asc</gml:fileReference><!-- URI -->

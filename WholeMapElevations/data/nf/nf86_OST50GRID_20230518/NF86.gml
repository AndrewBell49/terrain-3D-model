		...
		<os:ElevationGridCoverage gml:id="os.t50.nf86.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nf86.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nf86.origin">
							<gml:pos>80000 860000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NF86.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nc70.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nc70.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nc70.origin">
							<gml:pos>270000 900000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NC70.asc</gml:fileReference><!-- URI -->

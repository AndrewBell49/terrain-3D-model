		...
		<os:ElevationGridCoverage gml:id="os.t50.nc81.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nc81.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nc81.origin">
							<gml:pos>280000 910000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NC81.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nc72.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nc72.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nc72.origin">
							<gml:pos>270000 920000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NC72.asc</gml:fileReference><!-- URI -->

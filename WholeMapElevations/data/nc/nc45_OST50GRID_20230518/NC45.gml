		...
		<os:ElevationGridCoverage gml:id="os.t50.nc45.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nc45.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nc45.origin">
							<gml:pos>240000 950000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NC45.asc</gml:fileReference><!-- URI -->

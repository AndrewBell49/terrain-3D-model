		...
		<os:ElevationGridCoverage gml:id="os.t50.nc66.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nc66.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nc66.origin">
							<gml:pos>260000 960000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NC66.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.st47.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st47.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st47.origin">
							<gml:pos>340000 170000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST47.asc</gml:fileReference><!-- URI -->

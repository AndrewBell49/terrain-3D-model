		...
		<os:ElevationGridCoverage gml:id="os.t50.st18.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st18.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st18.origin">
							<gml:pos>310000 180000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST18.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.st70.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st70.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st70.origin">
							<gml:pos>370000 100000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST70.asc</gml:fileReference><!-- URI -->

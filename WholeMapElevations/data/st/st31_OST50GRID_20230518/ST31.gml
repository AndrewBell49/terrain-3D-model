		...
		<os:ElevationGridCoverage gml:id="os.t50.st31.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st31.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st31.origin">
							<gml:pos>330000 110000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST31.asc</gml:fileReference><!-- URI -->

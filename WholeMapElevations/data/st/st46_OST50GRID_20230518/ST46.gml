		...
		<os:ElevationGridCoverage gml:id="os.t50.st46.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st46.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st46.origin">
							<gml:pos>340000 160000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST46.asc</gml:fileReference><!-- URI -->

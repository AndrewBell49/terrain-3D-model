		...
		<os:ElevationGridCoverage gml:id="os.t50.st72.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st72.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st72.origin">
							<gml:pos>370000 120000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST72.asc</gml:fileReference><!-- URI -->

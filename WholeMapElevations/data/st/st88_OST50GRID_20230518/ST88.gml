		...
		<os:ElevationGridCoverage gml:id="os.t50.st88.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st88.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st88.origin">
							<gml:pos>380000 180000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST88.asc</gml:fileReference><!-- URI -->

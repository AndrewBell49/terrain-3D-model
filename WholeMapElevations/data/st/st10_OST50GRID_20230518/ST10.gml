		...
		<os:ElevationGridCoverage gml:id="os.t50.st10.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st10.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st10.origin">
							<gml:pos>310000 100000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST10.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.st25.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st25.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st25.origin">
							<gml:pos>320000 150000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST25.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.st28.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st28.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st28.origin">
							<gml:pos>320000 180000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST28.asc</gml:fileReference><!-- URI -->

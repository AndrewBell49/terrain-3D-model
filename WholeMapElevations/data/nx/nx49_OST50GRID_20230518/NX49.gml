		...
		<os:ElevationGridCoverage gml:id="os.t50.nx49.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nx49.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nx49.origin">
							<gml:pos>240000 590000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NX49.asc</gml:fileReference><!-- URI -->

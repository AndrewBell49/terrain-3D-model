		...
		<os:ElevationGridCoverage gml:id="os.t50.nx64.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nx64.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nx64.origin">
							<gml:pos>260000 540000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NX64.asc</gml:fileReference><!-- URI -->

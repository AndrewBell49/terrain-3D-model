		...
		<os:ElevationGridCoverage gml:id="os.t50.nx05.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nx05.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nx05.origin">
							<gml:pos>200000 550000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NX05.asc</gml:fileReference><!-- URI -->

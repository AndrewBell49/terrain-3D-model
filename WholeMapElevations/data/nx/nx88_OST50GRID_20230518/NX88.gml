		...
		<os:ElevationGridCoverage gml:id="os.t50.nx88.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nx88.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nx88.origin">
							<gml:pos>280000 580000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NX88.asc</gml:fileReference><!-- URI -->

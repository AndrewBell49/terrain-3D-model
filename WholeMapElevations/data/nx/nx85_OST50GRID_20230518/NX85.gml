		...
		<os:ElevationGridCoverage gml:id="os.t50.nx85.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nx85.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nx85.origin">
							<gml:pos>280000 550000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NX85.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nx90.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nx90.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nx90.origin">
							<gml:pos>290000 500000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NX90.asc</gml:fileReference><!-- URI -->

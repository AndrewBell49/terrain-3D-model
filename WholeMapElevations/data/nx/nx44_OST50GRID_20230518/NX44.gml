		...
		<os:ElevationGridCoverage gml:id="os.t50.nx44.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nx44.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nx44.origin">
							<gml:pos>240000 540000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NX44.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nx56.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nx56.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nx56.origin">
							<gml:pos>250000 560000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NX56.asc</gml:fileReference><!-- URI -->

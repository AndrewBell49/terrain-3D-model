		...
		<os:ElevationGridCoverage gml:id="os.t50.nu03.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nu03.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nu03.origin">
							<gml:pos>400000 630000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NU03.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nu23.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nu23.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nu23.origin">
							<gml:pos>420000 630000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NU23.asc</gml:fileReference><!-- URI -->

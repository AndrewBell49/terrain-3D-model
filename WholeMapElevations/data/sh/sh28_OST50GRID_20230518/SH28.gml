		...
		<os:ElevationGridCoverage gml:id="os.t50.sh28.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sh28.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sh28.origin">
							<gml:pos>220000 380000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SH28.asc</gml:fileReference><!-- URI -->

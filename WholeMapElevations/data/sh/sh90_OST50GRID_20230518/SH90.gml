		...
		<os:ElevationGridCoverage gml:id="os.t50.sh90.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sh90.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sh90.origin">
							<gml:pos>290000 300000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SH90.asc</gml:fileReference><!-- URI -->

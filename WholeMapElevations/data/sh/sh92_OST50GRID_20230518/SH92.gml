		...
		<os:ElevationGridCoverage gml:id="os.t50.sh92.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sh92.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sh92.origin">
							<gml:pos>290000 320000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SH92.asc</gml:fileReference><!-- URI -->

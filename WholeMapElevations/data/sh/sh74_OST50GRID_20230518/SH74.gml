		...
		<os:ElevationGridCoverage gml:id="os.t50.sh74.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sh74.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sh74.origin">
							<gml:pos>270000 340000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SH74.asc</gml:fileReference><!-- URI -->

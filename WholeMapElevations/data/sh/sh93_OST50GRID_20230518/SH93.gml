		...
		<os:ElevationGridCoverage gml:id="os.t50.sh93.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sh93.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sh93.origin">
							<gml:pos>290000 330000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SH93.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sh96.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sh96.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sh96.origin">
							<gml:pos>290000 360000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SH96.asc</gml:fileReference><!-- URI -->

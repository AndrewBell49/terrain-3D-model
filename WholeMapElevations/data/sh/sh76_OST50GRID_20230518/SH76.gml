		...
		<os:ElevationGridCoverage gml:id="os.t50.sh76.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sh76.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sh76.origin">
							<gml:pos>270000 360000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SH76.asc</gml:fileReference><!-- URI -->

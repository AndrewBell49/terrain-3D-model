		...
		<os:ElevationGridCoverage gml:id="os.t50.sh66.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sh66.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sh66.origin">
							<gml:pos>260000 360000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SH66.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sh49.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sh49.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sh49.origin">
							<gml:pos>240000 390000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SH49.asc</gml:fileReference><!-- URI -->

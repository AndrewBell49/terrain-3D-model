		...
		<os:ElevationGridCoverage gml:id="os.t50.sh86.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sh86.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sh86.origin">
							<gml:pos>280000 360000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SH86.asc</gml:fileReference><!-- URI -->

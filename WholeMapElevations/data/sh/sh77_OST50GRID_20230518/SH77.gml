		...
		<os:ElevationGridCoverage gml:id="os.t50.sh77.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sh77.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sh77.origin">
							<gml:pos>270000 370000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SH77.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sz29.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sz29.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sz29.origin">
							<gml:pos>420000 90000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SZ29.asc</gml:fileReference><!-- URI -->

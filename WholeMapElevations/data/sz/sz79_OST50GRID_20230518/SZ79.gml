		...
		<os:ElevationGridCoverage gml:id="os.t50.sz79.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sz79.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sz79.origin">
							<gml:pos>470000 90000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SZ79.asc</gml:fileReference><!-- URI -->

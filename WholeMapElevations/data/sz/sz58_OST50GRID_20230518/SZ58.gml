		...
		<os:ElevationGridCoverage gml:id="os.t50.sz58.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sz58.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sz58.origin">
							<gml:pos>450000 80000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SZ58.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sz08.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sz08.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sz08.origin">
							<gml:pos>400000 80000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SZ08.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nt43.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt43.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt43.origin">
							<gml:pos>340000 630000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT43.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nt51.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt51.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt51.origin">
							<gml:pos>350000 610000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT51.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nt81.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt81.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt81.origin">
							<gml:pos>380000 610000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT81.asc</gml:fileReference><!-- URI -->

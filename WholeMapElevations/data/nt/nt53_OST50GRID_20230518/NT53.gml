		...
		<os:ElevationGridCoverage gml:id="os.t50.nt53.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt53.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt53.origin">
							<gml:pos>350000 630000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT53.asc</gml:fileReference><!-- URI -->

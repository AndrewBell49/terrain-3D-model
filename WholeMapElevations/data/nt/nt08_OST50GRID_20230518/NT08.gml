		...
		<os:ElevationGridCoverage gml:id="os.t50.nt08.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt08.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt08.origin">
							<gml:pos>300000 680000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT08.asc</gml:fileReference><!-- URI -->

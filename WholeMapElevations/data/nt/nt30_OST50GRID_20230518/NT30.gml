		...
		<os:ElevationGridCoverage gml:id="os.t50.nt30.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt30.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt30.origin">
							<gml:pos>330000 600000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT30.asc</gml:fileReference><!-- URI -->

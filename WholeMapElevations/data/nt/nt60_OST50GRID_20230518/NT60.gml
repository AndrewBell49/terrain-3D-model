		...
		<os:ElevationGridCoverage gml:id="os.t50.nt60.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt60.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt60.origin">
							<gml:pos>360000 600000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT60.asc</gml:fileReference><!-- URI -->

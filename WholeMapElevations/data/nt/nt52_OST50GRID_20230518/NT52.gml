		...
		<os:ElevationGridCoverage gml:id="os.t50.nt52.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt52.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt52.origin">
							<gml:pos>350000 620000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT52.asc</gml:fileReference><!-- URI -->

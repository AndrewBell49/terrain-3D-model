		...
		<os:ElevationGridCoverage gml:id="os.t50.nt04.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt04.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt04.origin">
							<gml:pos>300000 640000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT04.asc</gml:fileReference><!-- URI -->

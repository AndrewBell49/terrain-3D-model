		...
		<os:ElevationGridCoverage gml:id="os.t50.su31.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su31.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su31.origin">
							<gml:pos>430000 110000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU31.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.su56.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su56.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su56.origin">
							<gml:pos>450000 160000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU56.asc</gml:fileReference><!-- URI -->

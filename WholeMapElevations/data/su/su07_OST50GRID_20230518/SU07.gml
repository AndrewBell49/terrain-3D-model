		...
		<os:ElevationGridCoverage gml:id="os.t50.su07.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su07.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su07.origin">
							<gml:pos>400000 170000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU07.asc</gml:fileReference><!-- URI -->

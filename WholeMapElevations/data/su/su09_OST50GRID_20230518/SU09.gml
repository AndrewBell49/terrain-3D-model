		...
		<os:ElevationGridCoverage gml:id="os.t50.su09.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su09.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su09.origin">
							<gml:pos>400000 190000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU09.asc</gml:fileReference><!-- URI -->

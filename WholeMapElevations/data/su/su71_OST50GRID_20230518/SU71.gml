		...
		<os:ElevationGridCoverage gml:id="os.t50.su71.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su71.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su71.origin">
							<gml:pos>470000 110000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU71.asc</gml:fileReference><!-- URI -->

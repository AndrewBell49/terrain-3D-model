		...
		<os:ElevationGridCoverage gml:id="os.t50.su66.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su66.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su66.origin">
							<gml:pos>460000 160000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU66.asc</gml:fileReference><!-- URI -->

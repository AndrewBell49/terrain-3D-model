		...
		<os:ElevationGridCoverage gml:id="os.t50.su35.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su35.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su35.origin">
							<gml:pos>430000 150000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU35.asc</gml:fileReference><!-- URI -->

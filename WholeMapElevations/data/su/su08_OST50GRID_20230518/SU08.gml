		...
		<os:ElevationGridCoverage gml:id="os.t50.su08.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su08.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su08.origin">
							<gml:pos>400000 180000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU08.asc</gml:fileReference><!-- URI -->

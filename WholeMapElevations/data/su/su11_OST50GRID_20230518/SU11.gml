		...
		<os:ElevationGridCoverage gml:id="os.t50.su11.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su11.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su11.origin">
							<gml:pos>410000 110000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU11.asc</gml:fileReference><!-- URI -->

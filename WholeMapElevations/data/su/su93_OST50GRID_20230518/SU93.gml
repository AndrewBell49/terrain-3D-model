		...
		<os:ElevationGridCoverage gml:id="os.t50.su93.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su93.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su93.origin">
							<gml:pos>490000 130000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU93.asc</gml:fileReference><!-- URI -->

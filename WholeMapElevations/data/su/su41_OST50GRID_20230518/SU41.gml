		...
		<os:ElevationGridCoverage gml:id="os.t50.su41.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su41.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su41.origin">
							<gml:pos>440000 110000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU41.asc</gml:fileReference><!-- URI -->

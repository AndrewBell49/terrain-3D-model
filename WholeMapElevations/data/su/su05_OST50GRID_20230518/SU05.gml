		...
		<os:ElevationGridCoverage gml:id="os.t50.su05.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su05.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su05.origin">
							<gml:pos>400000 150000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU05.asc</gml:fileReference><!-- URI -->

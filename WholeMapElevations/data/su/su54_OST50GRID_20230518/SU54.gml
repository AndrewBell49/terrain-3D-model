		...
		<os:ElevationGridCoverage gml:id="os.t50.su54.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su54.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su54.origin">
							<gml:pos>450000 140000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU54.asc</gml:fileReference><!-- URI -->

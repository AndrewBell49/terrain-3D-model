		...
		<os:ElevationGridCoverage gml:id="os.t50.sx67.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sx67.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sx67.origin">
							<gml:pos>260000 70000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SX67.asc</gml:fileReference><!-- URI -->

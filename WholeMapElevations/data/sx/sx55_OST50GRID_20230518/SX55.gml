		...
		<os:ElevationGridCoverage gml:id="os.t50.sx55.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sx55.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sx55.origin">
							<gml:pos>250000 50000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SX55.asc</gml:fileReference><!-- URI -->

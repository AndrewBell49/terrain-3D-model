		...
		<os:ElevationGridCoverage gml:id="os.t50.sx77.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sx77.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sx77.origin">
							<gml:pos>270000 70000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SX77.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sx04.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sx04.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sx04.origin">
							<gml:pos>200000 40000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SX04.asc</gml:fileReference><!-- URI -->

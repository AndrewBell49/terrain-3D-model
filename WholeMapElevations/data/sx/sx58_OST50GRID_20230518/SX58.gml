		...
		<os:ElevationGridCoverage gml:id="os.t50.sx58.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sx58.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sx58.origin">
							<gml:pos>250000 80000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SX58.asc</gml:fileReference><!-- URI -->

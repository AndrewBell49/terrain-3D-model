		...
		<os:ElevationGridCoverage gml:id="os.t50.sx46.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sx46.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sx46.origin">
							<gml:pos>240000 60000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SX46.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sx47.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sx47.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sx47.origin">
							<gml:pos>240000 70000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SX47.asc</gml:fileReference><!-- URI -->

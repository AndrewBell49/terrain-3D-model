		...
		<os:ElevationGridCoverage gml:id="os.t50.so90.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so90.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so90.origin">
							<gml:pos>390000 200000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO90.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.so61.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so61.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so61.origin">
							<gml:pos>360000 210000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO61.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.so19.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so19.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so19.origin">
							<gml:pos>310000 290000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO19.asc</gml:fileReference><!-- URI -->

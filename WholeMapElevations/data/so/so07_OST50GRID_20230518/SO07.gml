		...
		<os:ElevationGridCoverage gml:id="os.t50.so07.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so07.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so07.origin">
							<gml:pos>300000 270000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO07.asc</gml:fileReference><!-- URI -->

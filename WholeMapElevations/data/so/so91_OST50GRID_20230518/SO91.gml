		...
		<os:ElevationGridCoverage gml:id="os.t50.so91.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so91.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so91.origin">
							<gml:pos>390000 210000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO91.asc</gml:fileReference><!-- URI -->

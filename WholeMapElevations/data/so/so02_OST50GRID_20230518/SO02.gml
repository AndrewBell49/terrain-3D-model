		...
		<os:ElevationGridCoverage gml:id="os.t50.so02.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so02.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so02.origin">
							<gml:pos>300000 220000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO02.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.so26.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so26.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so26.origin">
							<gml:pos>320000 260000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO26.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.so80.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so80.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so80.origin">
							<gml:pos>380000 200000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO80.asc</gml:fileReference><!-- URI -->

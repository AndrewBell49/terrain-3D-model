		...
		<os:ElevationGridCoverage gml:id="os.t50.so62.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so62.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so62.origin">
							<gml:pos>360000 220000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO62.asc</gml:fileReference><!-- URI -->

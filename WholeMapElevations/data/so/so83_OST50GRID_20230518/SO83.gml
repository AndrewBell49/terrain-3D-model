		...
		<os:ElevationGridCoverage gml:id="os.t50.so83.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so83.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so83.origin">
							<gml:pos>380000 230000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO83.asc</gml:fileReference><!-- URI -->

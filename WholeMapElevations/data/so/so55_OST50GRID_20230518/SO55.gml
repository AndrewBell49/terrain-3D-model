		...
		<os:ElevationGridCoverage gml:id="os.t50.so55.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so55.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so55.origin">
							<gml:pos>350000 250000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO55.asc</gml:fileReference><!-- URI -->

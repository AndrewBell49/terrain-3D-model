		...
		<os:ElevationGridCoverage gml:id="os.t50.tr02.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tr02.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tr02.origin">
							<gml:pos>600000 120000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TR02.asc</gml:fileReference><!-- URI -->

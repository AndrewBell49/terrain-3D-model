		...
		<os:ElevationGridCoverage gml:id="os.t50.tr24.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tr24.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tr24.origin">
							<gml:pos>620000 140000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TR24.asc</gml:fileReference><!-- URI -->

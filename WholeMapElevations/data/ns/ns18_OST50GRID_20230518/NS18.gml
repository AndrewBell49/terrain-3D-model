		...
		<os:ElevationGridCoverage gml:id="os.t50.ns18.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ns18.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ns18.origin">
							<gml:pos>210000 680000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NS18.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.ns91.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ns91.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ns91.origin">
							<gml:pos>290000 610000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NS91.asc</gml:fileReference><!-- URI -->

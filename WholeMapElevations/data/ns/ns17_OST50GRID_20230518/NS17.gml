		...
		<os:ElevationGridCoverage gml:id="os.t50.ns17.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ns17.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ns17.origin">
							<gml:pos>210000 670000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NS17.asc</gml:fileReference><!-- URI -->

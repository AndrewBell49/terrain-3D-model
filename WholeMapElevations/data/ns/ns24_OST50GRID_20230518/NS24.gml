		...
		<os:ElevationGridCoverage gml:id="os.t50.ns24.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ns24.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ns24.origin">
							<gml:pos>220000 640000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NS24.asc</gml:fileReference><!-- URI -->

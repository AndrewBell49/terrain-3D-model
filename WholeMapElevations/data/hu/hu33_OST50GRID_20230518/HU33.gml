		...
		<os:ElevationGridCoverage gml:id="os.t50.hu33.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hu33.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hu33.origin">
							<gml:pos>430000 1130000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HU33.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.hu32.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hu32.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hu32.origin">
							<gml:pos>430000 1120000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HU32.asc</gml:fileReference><!-- URI -->

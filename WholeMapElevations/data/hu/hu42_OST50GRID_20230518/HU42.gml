		...
		<os:ElevationGridCoverage gml:id="os.t50.hu42.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hu42.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hu42.origin">
							<gml:pos>440000 1120000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HU42.asc</gml:fileReference><!-- URI -->

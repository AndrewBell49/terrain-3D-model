		...
		<os:ElevationGridCoverage gml:id="os.t50.hu28.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hu28.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hu28.origin">
							<gml:pos>420000 1180000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HU28.asc</gml:fileReference><!-- URI -->

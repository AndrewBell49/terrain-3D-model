		...
		<os:ElevationGridCoverage gml:id="os.t50.hu24.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hu24.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hu24.origin">
							<gml:pos>420000 1140000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HU24.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sn10.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sn10.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sn10.origin">
							<gml:pos>210000 200000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SN10.asc</gml:fileReference><!-- URI -->

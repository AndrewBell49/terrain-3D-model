		...
		<os:ElevationGridCoverage gml:id="os.t50.sn99.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sn99.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sn99.origin">
							<gml:pos>290000 290000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SN99.asc</gml:fileReference><!-- URI -->

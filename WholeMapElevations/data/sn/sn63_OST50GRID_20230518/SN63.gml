		...
		<os:ElevationGridCoverage gml:id="os.t50.sn63.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sn63.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sn63.origin">
							<gml:pos>260000 230000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SN63.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sn24.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sn24.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sn24.origin">
							<gml:pos>220000 240000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SN24.asc</gml:fileReference><!-- URI -->

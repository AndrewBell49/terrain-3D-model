		...
		<os:ElevationGridCoverage gml:id="os.t50.sn98.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sn98.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sn98.origin">
							<gml:pos>290000 280000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SN98.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sn35.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sn35.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sn35.origin">
							<gml:pos>230000 250000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SN35.asc</gml:fileReference><!-- URI -->

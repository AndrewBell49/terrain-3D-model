		...
		<os:ElevationGridCoverage gml:id="os.t50.sn82.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sn82.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sn82.origin">
							<gml:pos>280000 220000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SN82.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sn80.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sn80.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sn80.origin">
							<gml:pos>280000 200000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SN80.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sn21.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sn21.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sn21.origin">
							<gml:pos>220000 210000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SN21.asc</gml:fileReference><!-- URI -->

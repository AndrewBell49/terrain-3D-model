		...
		<os:ElevationGridCoverage gml:id="os.t50.tf12.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tf12.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tf12.origin">
							<gml:pos>510000 320000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TF12.asc</gml:fileReference><!-- URI -->

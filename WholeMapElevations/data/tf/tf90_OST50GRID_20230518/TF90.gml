		...
		<os:ElevationGridCoverage gml:id="os.t50.tf90.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tf90.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tf90.origin">
							<gml:pos>590000 300000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TF90.asc</gml:fileReference><!-- URI -->

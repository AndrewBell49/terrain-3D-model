		...
		<os:ElevationGridCoverage gml:id="os.t50.tf50.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tf50.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tf50.origin">
							<gml:pos>550000 300000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TF50.asc</gml:fileReference><!-- URI -->

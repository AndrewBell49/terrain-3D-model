		...
		<os:ElevationGridCoverage gml:id="os.t50.tf40.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tf40.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tf40.origin">
							<gml:pos>540000 300000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TF40.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tf45.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tf45.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tf45.origin">
							<gml:pos>540000 350000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TF45.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tf07.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tf07.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tf07.origin">
							<gml:pos>500000 370000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TF07.asc</gml:fileReference><!-- URI -->

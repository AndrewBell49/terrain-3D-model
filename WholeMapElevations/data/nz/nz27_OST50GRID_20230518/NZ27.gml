		...
		<os:ElevationGridCoverage gml:id="os.t50.nz27.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nz27.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nz27.origin">
							<gml:pos>420000 570000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NZ27.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nz01.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nz01.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nz01.origin">
							<gml:pos>400000 510000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NZ01.asc</gml:fileReference><!-- URI -->

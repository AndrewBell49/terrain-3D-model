		...
		<os:ElevationGridCoverage gml:id="os.t50.nz22.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nz22.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nz22.origin">
							<gml:pos>420000 520000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NZ22.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nz90.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nz90.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nz90.origin">
							<gml:pos>490000 500000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NZ90.asc</gml:fileReference><!-- URI -->

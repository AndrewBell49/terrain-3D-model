		...
		<os:ElevationGridCoverage gml:id="os.t50.nz12.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nz12.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nz12.origin">
							<gml:pos>410000 520000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NZ12.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nz43.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nz43.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nz43.origin">
							<gml:pos>440000 530000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NZ43.asc</gml:fileReference><!-- URI -->

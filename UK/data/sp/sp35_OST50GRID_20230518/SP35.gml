		...
		<os:ElevationGridCoverage gml:id="os.t50.sp35.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sp35.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sp35.origin">
							<gml:pos>430000 250000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SP35.asc</gml:fileReference><!-- URI -->

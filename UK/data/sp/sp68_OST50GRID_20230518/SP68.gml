		...
		<os:ElevationGridCoverage gml:id="os.t50.sp68.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sp68.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sp68.origin">
							<gml:pos>460000 280000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SP68.asc</gml:fileReference><!-- URI -->

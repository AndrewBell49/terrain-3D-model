		...
		<os:ElevationGridCoverage gml:id="os.t50.sp01.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sp01.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sp01.origin">
							<gml:pos>400000 210000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SP01.asc</gml:fileReference><!-- URI -->

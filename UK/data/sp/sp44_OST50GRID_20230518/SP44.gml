		...
		<os:ElevationGridCoverage gml:id="os.t50.sp44.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sp44.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sp44.origin">
							<gml:pos>440000 240000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SP44.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sp95.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sp95.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sp95.origin">
							<gml:pos>490000 250000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SP95.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sp59.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sp59.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sp59.origin">
							<gml:pos>450000 290000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SP59.asc</gml:fileReference><!-- URI -->

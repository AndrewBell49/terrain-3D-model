		...
		<os:ElevationGridCoverage gml:id="os.t50.sp43.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sp43.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sp43.origin">
							<gml:pos>440000 230000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SP43.asc</gml:fileReference><!-- URI -->

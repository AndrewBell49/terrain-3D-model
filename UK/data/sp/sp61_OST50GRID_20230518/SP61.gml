		...
		<os:ElevationGridCoverage gml:id="os.t50.sp61.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sp61.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sp61.origin">
							<gml:pos>460000 210000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SP61.asc</gml:fileReference><!-- URI -->

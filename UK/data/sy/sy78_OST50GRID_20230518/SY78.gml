		...
		<os:ElevationGridCoverage gml:id="os.t50.sy78.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sy78.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sy78.origin">
							<gml:pos>370000 80000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SY78.asc</gml:fileReference><!-- URI -->

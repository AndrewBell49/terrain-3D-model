		...
		<os:ElevationGridCoverage gml:id="os.t50.sy58.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sy58.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sy58.origin">
							<gml:pos>350000 80000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SY58.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sy88.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sy88.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sy88.origin">
							<gml:pos>380000 80000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SY88.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sh65.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sh65.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sh65.origin">
							<gml:pos>260000 350000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SH65.asc</gml:fileReference><!-- URI -->

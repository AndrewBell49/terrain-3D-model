		...
		<os:ElevationGridCoverage gml:id="os.t50.sh57.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sh57.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sh57.origin">
							<gml:pos>250000 370000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SH57.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sh51.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sh51.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sh51.origin">
							<gml:pos>250000 310000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SH51.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sh63.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sh63.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sh63.origin">
							<gml:pos>260000 330000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SH63.asc</gml:fileReference><!-- URI -->

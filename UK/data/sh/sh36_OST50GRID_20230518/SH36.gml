		...
		<os:ElevationGridCoverage gml:id="os.t50.sh36.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sh36.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sh36.origin">
							<gml:pos>230000 360000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SH36.asc</gml:fileReference><!-- URI -->

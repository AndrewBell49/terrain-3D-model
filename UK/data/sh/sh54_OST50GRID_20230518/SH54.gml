		...
		<os:ElevationGridCoverage gml:id="os.t50.sh54.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sh54.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sh54.origin">
							<gml:pos>250000 340000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SH54.asc</gml:fileReference><!-- URI -->

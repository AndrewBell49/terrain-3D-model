		...
		<os:ElevationGridCoverage gml:id="os.t50.sh33.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sh33.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sh33.origin">
							<gml:pos>230000 330000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SH33.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tm08.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tm08.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tm08.origin">
							<gml:pos>600000 280000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TM08.asc</gml:fileReference><!-- URI -->

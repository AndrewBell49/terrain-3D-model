		...
		<os:ElevationGridCoverage gml:id="os.t50.tm11.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tm11.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tm11.origin">
							<gml:pos>610000 210000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TM11.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tm38.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tm38.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tm38.origin">
							<gml:pos>630000 280000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TM38.asc</gml:fileReference><!-- URI -->

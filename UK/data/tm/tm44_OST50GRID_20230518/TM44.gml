		...
		<os:ElevationGridCoverage gml:id="os.t50.tm44.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tm44.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tm44.origin">
							<gml:pos>640000 240000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TM44.asc</gml:fileReference><!-- URI -->

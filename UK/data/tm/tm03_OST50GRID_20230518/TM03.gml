		...
		<os:ElevationGridCoverage gml:id="os.t50.tm03.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tm03.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tm03.origin">
							<gml:pos>600000 230000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TM03.asc</gml:fileReference><!-- URI -->

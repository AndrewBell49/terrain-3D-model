		...
		<os:ElevationGridCoverage gml:id="os.t50.tm27.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tm27.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tm27.origin">
							<gml:pos>620000 270000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TM27.asc</gml:fileReference><!-- URI -->

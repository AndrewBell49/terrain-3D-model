		...
		<os:ElevationGridCoverage gml:id="os.t50.tm12.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tm12.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tm12.origin">
							<gml:pos>610000 220000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TM12.asc</gml:fileReference><!-- URI -->

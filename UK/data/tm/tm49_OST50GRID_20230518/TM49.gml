		...
		<os:ElevationGridCoverage gml:id="os.t50.tm49.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tm49.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tm49.origin">
							<gml:pos>640000 290000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TM49.asc</gml:fileReference><!-- URI -->

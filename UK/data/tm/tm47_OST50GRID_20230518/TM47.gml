		...
		<os:ElevationGridCoverage gml:id="os.t50.tm47.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tm47.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tm47.origin">
							<gml:pos>640000 270000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TM47.asc</gml:fileReference><!-- URI -->

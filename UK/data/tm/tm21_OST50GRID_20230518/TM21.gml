		...
		<os:ElevationGridCoverage gml:id="os.t50.tm21.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tm21.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tm21.origin">
							<gml:pos>620000 210000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TM21.asc</gml:fileReference><!-- URI -->

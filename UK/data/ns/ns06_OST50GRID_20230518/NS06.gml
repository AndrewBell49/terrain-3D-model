		...
		<os:ElevationGridCoverage gml:id="os.t50.ns06.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ns06.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ns06.origin">
							<gml:pos>200000 660000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NS06.asc</gml:fileReference><!-- URI -->

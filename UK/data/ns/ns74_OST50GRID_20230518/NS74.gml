		...
		<os:ElevationGridCoverage gml:id="os.t50.ns74.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ns74.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ns74.origin">
							<gml:pos>270000 640000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NS74.asc</gml:fileReference><!-- URI -->

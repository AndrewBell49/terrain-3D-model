		...
		<os:ElevationGridCoverage gml:id="os.t50.ns92.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ns92.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ns92.origin">
							<gml:pos>290000 620000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NS92.asc</gml:fileReference><!-- URI -->

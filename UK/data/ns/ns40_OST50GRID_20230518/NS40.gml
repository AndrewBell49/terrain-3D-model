		...
		<os:ElevationGridCoverage gml:id="os.t50.ns40.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ns40.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ns40.origin">
							<gml:pos>240000 600000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NS40.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.ns08.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ns08.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ns08.origin">
							<gml:pos>200000 680000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NS08.asc</gml:fileReference><!-- URI -->

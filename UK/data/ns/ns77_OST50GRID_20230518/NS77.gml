		...
		<os:ElevationGridCoverage gml:id="os.t50.ns77.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ns77.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ns77.origin">
							<gml:pos>270000 670000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NS77.asc</gml:fileReference><!-- URI -->

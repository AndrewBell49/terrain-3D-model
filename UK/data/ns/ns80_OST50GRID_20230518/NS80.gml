		...
		<os:ElevationGridCoverage gml:id="os.t50.ns80.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ns80.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ns80.origin">
							<gml:pos>280000 600000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NS80.asc</gml:fileReference><!-- URI -->

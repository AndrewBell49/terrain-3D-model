		...
		<os:ElevationGridCoverage gml:id="os.t50.ns87.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ns87.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ns87.origin">
							<gml:pos>280000 670000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NS87.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.ns19.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ns19.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ns19.origin">
							<gml:pos>210000 690000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NS19.asc</gml:fileReference><!-- URI -->

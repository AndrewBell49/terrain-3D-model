		...
		<os:ElevationGridCoverage gml:id="os.t50.ns20.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ns20.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ns20.origin">
							<gml:pos>220000 600000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NS20.asc</gml:fileReference><!-- URI -->

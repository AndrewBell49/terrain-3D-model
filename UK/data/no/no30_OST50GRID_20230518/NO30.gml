		...
		<os:ElevationGridCoverage gml:id="os.t50.no30.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.no30.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.no30.origin">
							<gml:pos>330000 700000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NO30.asc</gml:fileReference><!-- URI -->

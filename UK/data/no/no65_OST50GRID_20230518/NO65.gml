		...
		<os:ElevationGridCoverage gml:id="os.t50.no65.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.no65.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.no65.origin">
							<gml:pos>360000 750000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NO65.asc</gml:fileReference><!-- URI -->

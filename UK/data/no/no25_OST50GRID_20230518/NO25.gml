		...
		<os:ElevationGridCoverage gml:id="os.t50.no25.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.no25.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.no25.origin">
							<gml:pos>320000 750000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NO25.asc</gml:fileReference><!-- URI -->

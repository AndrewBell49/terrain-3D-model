		...
		<os:ElevationGridCoverage gml:id="os.t50.no35.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.no35.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.no35.origin">
							<gml:pos>330000 750000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NO35.asc</gml:fileReference><!-- URI -->

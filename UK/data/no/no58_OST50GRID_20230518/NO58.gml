		...
		<os:ElevationGridCoverage gml:id="os.t50.no58.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.no58.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.no58.origin">
							<gml:pos>350000 780000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NO58.asc</gml:fileReference><!-- URI -->

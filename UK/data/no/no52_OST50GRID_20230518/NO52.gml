		...
		<os:ElevationGridCoverage gml:id="os.t50.no52.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.no52.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.no52.origin">
							<gml:pos>350000 720000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NO52.asc</gml:fileReference><!-- URI -->

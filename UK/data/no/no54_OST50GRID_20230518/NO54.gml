		...
		<os:ElevationGridCoverage gml:id="os.t50.no54.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.no54.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.no54.origin">
							<gml:pos>350000 740000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NO54.asc</gml:fileReference><!-- URI -->

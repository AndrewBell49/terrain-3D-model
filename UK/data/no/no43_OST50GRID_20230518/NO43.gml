		...
		<os:ElevationGridCoverage gml:id="os.t50.no43.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.no43.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.no43.origin">
							<gml:pos>340000 730000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NO43.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sk31.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sk31.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sk31.origin">
							<gml:pos>430000 310000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SK31.asc</gml:fileReference><!-- URI -->

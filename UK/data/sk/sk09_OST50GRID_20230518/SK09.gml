		...
		<os:ElevationGridCoverage gml:id="os.t50.sk09.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sk09.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sk09.origin">
							<gml:pos>400000 390000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SK09.asc</gml:fileReference><!-- URI -->

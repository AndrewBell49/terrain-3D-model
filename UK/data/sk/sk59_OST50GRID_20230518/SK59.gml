		...
		<os:ElevationGridCoverage gml:id="os.t50.sk59.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sk59.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sk59.origin">
							<gml:pos>450000 390000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SK59.asc</gml:fileReference><!-- URI -->

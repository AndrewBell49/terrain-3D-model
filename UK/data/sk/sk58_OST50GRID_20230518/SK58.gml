		...
		<os:ElevationGridCoverage gml:id="os.t50.sk58.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sk58.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sk58.origin">
							<gml:pos>450000 380000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SK58.asc</gml:fileReference><!-- URI -->

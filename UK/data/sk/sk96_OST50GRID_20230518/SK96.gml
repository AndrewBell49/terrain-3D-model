		...
		<os:ElevationGridCoverage gml:id="os.t50.sk96.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sk96.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sk96.origin">
							<gml:pos>490000 360000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SK96.asc</gml:fileReference><!-- URI -->

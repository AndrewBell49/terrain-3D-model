		...
		<os:ElevationGridCoverage gml:id="os.t50.sk36.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sk36.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sk36.origin">
							<gml:pos>430000 360000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SK36.asc</gml:fileReference><!-- URI -->

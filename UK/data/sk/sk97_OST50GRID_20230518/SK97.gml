		...
		<os:ElevationGridCoverage gml:id="os.t50.sk97.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sk97.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sk97.origin">
							<gml:pos>490000 370000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SK97.asc</gml:fileReference><!-- URI -->

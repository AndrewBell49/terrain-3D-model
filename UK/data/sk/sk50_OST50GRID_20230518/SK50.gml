		...
		<os:ElevationGridCoverage gml:id="os.t50.sk50.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sk50.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sk50.origin">
							<gml:pos>450000 300000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SK50.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tv49.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tv49.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tv49.origin">
							<gml:pos>540000 90000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TV49.asc</gml:fileReference><!-- URI -->

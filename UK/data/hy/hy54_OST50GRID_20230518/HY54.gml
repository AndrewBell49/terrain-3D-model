		...
		<os:ElevationGridCoverage gml:id="os.t50.hy54.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hy54.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hy54.origin">
							<gml:pos>350000 1040000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HY54.asc</gml:fileReference><!-- URI -->

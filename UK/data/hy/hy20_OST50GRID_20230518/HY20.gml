		...
		<os:ElevationGridCoverage gml:id="os.t50.hy20.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hy20.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hy20.origin">
							<gml:pos>320000 1000000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HY20.asc</gml:fileReference><!-- URI -->

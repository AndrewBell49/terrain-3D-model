		...
		<os:ElevationGridCoverage gml:id="os.t50.hy42.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hy42.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hy42.origin">
							<gml:pos>340000 1020000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HY42.asc</gml:fileReference><!-- URI -->

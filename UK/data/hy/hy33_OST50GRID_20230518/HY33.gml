		...
		<os:ElevationGridCoverage gml:id="os.t50.hy33.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hy33.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hy33.origin">
							<gml:pos>330000 1030000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HY33.asc</gml:fileReference><!-- URI -->

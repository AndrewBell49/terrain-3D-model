		...
		<os:ElevationGridCoverage gml:id="os.t50.hy62.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hy62.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hy62.origin">
							<gml:pos>360000 1020000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HY62.asc</gml:fileReference><!-- URI -->

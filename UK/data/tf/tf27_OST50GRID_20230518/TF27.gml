		...
		<os:ElevationGridCoverage gml:id="os.t50.tf27.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tf27.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tf27.origin">
							<gml:pos>520000 370000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TF27.asc</gml:fileReference><!-- URI -->

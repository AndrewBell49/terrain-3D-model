		...
		<os:ElevationGridCoverage gml:id="os.t50.tf24.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tf24.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tf24.origin">
							<gml:pos>520000 340000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TF24.asc</gml:fileReference><!-- URI -->

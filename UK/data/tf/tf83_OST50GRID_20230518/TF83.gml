		...
		<os:ElevationGridCoverage gml:id="os.t50.tf83.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tf83.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tf83.origin">
							<gml:pos>580000 330000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TF83.asc</gml:fileReference><!-- URI -->

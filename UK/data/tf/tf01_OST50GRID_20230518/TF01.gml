		...
		<os:ElevationGridCoverage gml:id="os.t50.tf01.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tf01.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tf01.origin">
							<gml:pos>500000 310000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TF01.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tf35.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tf35.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tf35.origin">
							<gml:pos>530000 350000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TF35.asc</gml:fileReference><!-- URI -->

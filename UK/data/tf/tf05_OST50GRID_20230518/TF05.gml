		...
		<os:ElevationGridCoverage gml:id="os.t50.tf05.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tf05.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tf05.origin">
							<gml:pos>500000 350000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TF05.asc</gml:fileReference><!-- URI -->

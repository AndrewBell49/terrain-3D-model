		...
		<os:ElevationGridCoverage gml:id="os.t50.tf28.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tf28.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tf28.origin">
							<gml:pos>520000 380000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TF28.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tf11.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tf11.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tf11.origin">
							<gml:pos>510000 310000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TF11.asc</gml:fileReference><!-- URI -->

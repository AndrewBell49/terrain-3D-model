		...
		<os:ElevationGridCoverage gml:id="os.t50.tf09.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tf09.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tf09.origin">
							<gml:pos>500000 390000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TF09.asc</gml:fileReference><!-- URI -->

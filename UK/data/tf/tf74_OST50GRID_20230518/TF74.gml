		...
		<os:ElevationGridCoverage gml:id="os.t50.tf74.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tf74.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tf74.origin">
							<gml:pos>570000 340000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TF74.asc</gml:fileReference><!-- URI -->

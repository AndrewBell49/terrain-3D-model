		...
		<os:ElevationGridCoverage gml:id="os.t50.tf80.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tf80.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tf80.origin">
							<gml:pos>580000 300000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TF80.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nx69.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nx69.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nx69.origin">
							<gml:pos>260000 590000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NX69.asc</gml:fileReference><!-- URI -->

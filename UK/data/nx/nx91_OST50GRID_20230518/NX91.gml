		...
		<os:ElevationGridCoverage gml:id="os.t50.nx91.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nx91.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nx91.origin">
							<gml:pos>290000 510000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NX91.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nx93.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nx93.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nx93.origin">
							<gml:pos>290000 530000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NX93.asc</gml:fileReference><!-- URI -->

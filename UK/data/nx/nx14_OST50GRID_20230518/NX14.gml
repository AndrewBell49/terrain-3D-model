		...
		<os:ElevationGridCoverage gml:id="os.t50.nx14.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nx14.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nx14.origin">
							<gml:pos>210000 540000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NX14.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nx38.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nx38.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nx38.origin">
							<gml:pos>230000 580000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NX38.asc</gml:fileReference><!-- URI -->

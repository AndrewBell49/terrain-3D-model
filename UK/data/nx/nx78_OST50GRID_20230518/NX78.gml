		...
		<os:ElevationGridCoverage gml:id="os.t50.nx78.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nx78.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nx78.origin">
							<gml:pos>270000 580000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NX78.asc</gml:fileReference><!-- URI -->

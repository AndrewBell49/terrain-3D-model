		...
		<os:ElevationGridCoverage gml:id="os.t50.nx57.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nx57.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nx57.origin">
							<gml:pos>250000 570000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NX57.asc</gml:fileReference><!-- URI -->

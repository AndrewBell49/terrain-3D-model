		...
		<os:ElevationGridCoverage gml:id="os.t50.nx13.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nx13.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nx13.origin">
							<gml:pos>210000 530000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NX13.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nz28.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nz28.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nz28.origin">
							<gml:pos>420000 580000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NZ28.asc</gml:fileReference><!-- URI -->

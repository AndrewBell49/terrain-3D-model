		...
		<os:ElevationGridCoverage gml:id="os.t50.nz34.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nz34.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nz34.origin">
							<gml:pos>430000 540000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NZ34.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nz39.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nz39.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nz39.origin">
							<gml:pos>430000 590000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NZ39.asc</gml:fileReference><!-- URI -->

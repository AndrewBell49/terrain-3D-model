		...
		<os:ElevationGridCoverage gml:id="os.t50.nz44.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nz44.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nz44.origin">
							<gml:pos>440000 540000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NZ44.asc</gml:fileReference><!-- URI -->

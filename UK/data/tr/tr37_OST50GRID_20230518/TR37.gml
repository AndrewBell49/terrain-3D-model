		...
		<os:ElevationGridCoverage gml:id="os.t50.tr37.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tr37.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tr37.origin">
							<gml:pos>630000 170000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TR37.asc</gml:fileReference><!-- URI -->

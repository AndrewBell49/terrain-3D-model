		...
		<os:ElevationGridCoverage gml:id="os.t50.tr36.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tr36.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tr36.origin">
							<gml:pos>630000 160000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TR36.asc</gml:fileReference><!-- URI -->

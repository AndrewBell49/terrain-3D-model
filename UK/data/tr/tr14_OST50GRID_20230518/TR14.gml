		...
		<os:ElevationGridCoverage gml:id="os.t50.tr14.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tr14.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tr14.origin">
							<gml:pos>610000 140000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TR14.asc</gml:fileReference><!-- URI -->

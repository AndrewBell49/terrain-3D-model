		...
		<os:ElevationGridCoverage gml:id="os.t50.tr16.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tr16.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tr16.origin">
							<gml:pos>610000 160000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TR16.asc</gml:fileReference><!-- URI -->

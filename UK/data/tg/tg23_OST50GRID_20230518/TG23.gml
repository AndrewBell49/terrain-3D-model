		...
		<os:ElevationGridCoverage gml:id="os.t50.tg23.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tg23.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tg23.origin">
							<gml:pos>620000 330000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TG23.asc</gml:fileReference><!-- URI -->

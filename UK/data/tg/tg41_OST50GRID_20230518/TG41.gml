		...
		<os:ElevationGridCoverage gml:id="os.t50.tg41.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tg41.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tg41.origin">
							<gml:pos>640000 310000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TG41.asc</gml:fileReference><!-- URI -->

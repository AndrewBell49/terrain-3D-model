		...
		<os:ElevationGridCoverage gml:id="os.t50.tg50.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tg50.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tg50.origin">
							<gml:pos>650000 300000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TG50.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tg32.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tg32.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tg32.origin">
							<gml:pos>630000 320000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TG32.asc</gml:fileReference><!-- URI -->

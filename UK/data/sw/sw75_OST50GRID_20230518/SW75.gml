		...
		<os:ElevationGridCoverage gml:id="os.t50.sw75.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sw75.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sw75.origin">
							<gml:pos>170000 50000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SW75.asc</gml:fileReference><!-- URI -->

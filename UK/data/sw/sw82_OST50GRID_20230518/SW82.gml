		...
		<os:ElevationGridCoverage gml:id="os.t50.sw82.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sw82.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sw82.origin">
							<gml:pos>180000 20000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SW82.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sw95.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sw95.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sw95.origin">
							<gml:pos>190000 50000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SW95.asc</gml:fileReference><!-- URI -->

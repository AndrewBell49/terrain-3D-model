		...
		<os:ElevationGridCoverage gml:id="os.t50.sw44.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sw44.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sw44.origin">
							<gml:pos>140000 40000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SW44.asc</gml:fileReference><!-- URI -->

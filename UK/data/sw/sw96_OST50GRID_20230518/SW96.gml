		...
		<os:ElevationGridCoverage gml:id="os.t50.sw96.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sw96.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sw96.origin">
							<gml:pos>190000 60000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SW96.asc</gml:fileReference><!-- URI -->

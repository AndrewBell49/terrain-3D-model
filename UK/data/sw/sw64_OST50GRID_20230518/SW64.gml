		...
		<os:ElevationGridCoverage gml:id="os.t50.sw64.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sw64.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sw64.origin">
							<gml:pos>160000 40000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SW64.asc</gml:fileReference><!-- URI -->

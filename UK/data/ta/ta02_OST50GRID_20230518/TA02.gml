		...
		<os:ElevationGridCoverage gml:id="os.t50.ta02.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ta02.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ta02.origin">
							<gml:pos>500000 420000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TA02.asc</gml:fileReference><!-- URI -->

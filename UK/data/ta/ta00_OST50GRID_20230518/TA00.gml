		...
		<os:ElevationGridCoverage gml:id="os.t50.ta00.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ta00.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ta00.origin">
							<gml:pos>500000 400000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TA00.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.ta07.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ta07.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ta07.origin">
							<gml:pos>500000 470000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TA07.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sm90.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sm90.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sm90.origin">
							<gml:pos>190000 200000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SM90.asc</gml:fileReference><!-- URI -->

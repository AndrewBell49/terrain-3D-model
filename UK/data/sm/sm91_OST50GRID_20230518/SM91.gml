		...
		<os:ElevationGridCoverage gml:id="os.t50.sm91.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sm91.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sm91.origin">
							<gml:pos>190000 210000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SM91.asc</gml:fileReference><!-- URI -->

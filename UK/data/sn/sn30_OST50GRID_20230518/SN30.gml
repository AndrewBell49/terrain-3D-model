		...
		<os:ElevationGridCoverage gml:id="os.t50.sn30.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sn30.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sn30.origin">
							<gml:pos>230000 200000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SN30.asc</gml:fileReference><!-- URI -->

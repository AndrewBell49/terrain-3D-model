		...
		<os:ElevationGridCoverage gml:id="os.t50.sn51.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sn51.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sn51.origin">
							<gml:pos>250000 210000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SN51.asc</gml:fileReference><!-- URI -->

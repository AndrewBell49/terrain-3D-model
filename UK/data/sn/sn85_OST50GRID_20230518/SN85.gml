		...
		<os:ElevationGridCoverage gml:id="os.t50.sn85.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sn85.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sn85.origin">
							<gml:pos>280000 250000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SN85.asc</gml:fileReference><!-- URI -->

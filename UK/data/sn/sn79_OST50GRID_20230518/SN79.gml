		...
		<os:ElevationGridCoverage gml:id="os.t50.sn79.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sn79.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sn79.origin">
							<gml:pos>270000 290000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SN79.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sn34.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sn34.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sn34.origin">
							<gml:pos>230000 240000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SN34.asc</gml:fileReference><!-- URI -->

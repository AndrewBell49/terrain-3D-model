		...
		<os:ElevationGridCoverage gml:id="os.t50.nw96.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nw96.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nw96.origin">
							<gml:pos>190000 560000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NW96.asc</gml:fileReference><!-- URI -->

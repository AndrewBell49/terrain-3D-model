		...
		<os:ElevationGridCoverage gml:id="os.t50.su12.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su12.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su12.origin">
							<gml:pos>410000 120000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU12.asc</gml:fileReference><!-- URI -->

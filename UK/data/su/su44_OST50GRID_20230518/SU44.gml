		...
		<os:ElevationGridCoverage gml:id="os.t50.su44.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su44.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su44.origin">
							<gml:pos>440000 140000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU44.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.su34.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su34.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su34.origin">
							<gml:pos>430000 140000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU34.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.su02.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su02.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su02.origin">
							<gml:pos>400000 120000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU02.asc</gml:fileReference><!-- URI -->

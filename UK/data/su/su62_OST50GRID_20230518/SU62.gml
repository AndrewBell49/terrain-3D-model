		...
		<os:ElevationGridCoverage gml:id="os.t50.su62.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su62.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su62.origin">
							<gml:pos>460000 120000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU62.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.su92.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su92.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su92.origin">
							<gml:pos>490000 120000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU92.asc</gml:fileReference><!-- URI -->

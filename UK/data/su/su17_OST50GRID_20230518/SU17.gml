		...
		<os:ElevationGridCoverage gml:id="os.t50.su17.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su17.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su17.origin">
							<gml:pos>410000 170000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU17.asc</gml:fileReference><!-- URI -->

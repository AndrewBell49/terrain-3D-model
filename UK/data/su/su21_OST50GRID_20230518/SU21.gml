		...
		<os:ElevationGridCoverage gml:id="os.t50.su21.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su21.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su21.origin">
							<gml:pos>420000 110000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU21.asc</gml:fileReference><!-- URI -->

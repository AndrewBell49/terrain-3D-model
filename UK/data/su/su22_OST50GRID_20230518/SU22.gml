		...
		<os:ElevationGridCoverage gml:id="os.t50.su22.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.su22.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.su22.origin">
							<gml:pos>420000 120000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SU22.asc</gml:fileReference><!-- URI -->

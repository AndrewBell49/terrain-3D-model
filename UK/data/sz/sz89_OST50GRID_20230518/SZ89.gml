		...
		<os:ElevationGridCoverage gml:id="os.t50.sz89.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sz89.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sz89.origin">
							<gml:pos>480000 90000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SZ89.asc</gml:fileReference><!-- URI -->

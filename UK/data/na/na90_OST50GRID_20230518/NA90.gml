		...
		<os:ElevationGridCoverage gml:id="os.t50.na90.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.na90.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.na90.origin">
							<gml:pos>90000 900000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NA90.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.na81.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.na81.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.na81.origin">
							<gml:pos>80000 910000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NA81.asc</gml:fileReference><!-- URI -->

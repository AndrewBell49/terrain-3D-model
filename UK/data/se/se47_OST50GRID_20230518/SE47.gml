		...
		<os:ElevationGridCoverage gml:id="os.t50.se47.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.se47.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.se47.origin">
							<gml:pos>440000 470000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SE47.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.se50.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.se50.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.se50.origin">
							<gml:pos>450000 400000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SE50.asc</gml:fileReference><!-- URI -->

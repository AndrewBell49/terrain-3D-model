		...
		<os:ElevationGridCoverage gml:id="os.t50.se74.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.se74.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.se74.origin">
							<gml:pos>470000 440000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SE74.asc</gml:fileReference><!-- URI -->

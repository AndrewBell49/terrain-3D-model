		...
		<os:ElevationGridCoverage gml:id="os.t50.nb43.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nb43.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nb43.origin">
							<gml:pos>140000 930000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NB43.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nb21.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nb21.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nb21.origin">
							<gml:pos>120000 910000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NB21.asc</gml:fileReference><!-- URI -->

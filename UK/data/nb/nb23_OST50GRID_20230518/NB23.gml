		...
		<os:ElevationGridCoverage gml:id="os.t50.nb23.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nb23.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nb23.origin">
							<gml:pos>120000 930000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NB23.asc</gml:fileReference><!-- URI -->

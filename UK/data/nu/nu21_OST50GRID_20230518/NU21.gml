		...
		<os:ElevationGridCoverage gml:id="os.t50.nu21.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nu21.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nu21.origin">
							<gml:pos>420000 610000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NU21.asc</gml:fileReference><!-- URI -->

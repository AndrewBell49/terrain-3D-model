		...
		<os:ElevationGridCoverage gml:id="os.t50.nu10.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nu10.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nu10.origin">
							<gml:pos>410000 600000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NU10.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nc15.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nc15.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nc15.origin">
							<gml:pos>210000 950000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NC15.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nc64.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nc64.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nc64.origin">
							<gml:pos>260000 940000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NC64.asc</gml:fileReference><!-- URI -->

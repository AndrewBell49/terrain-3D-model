		...
		<os:ElevationGridCoverage gml:id="os.t50.nc52.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nc52.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nc52.origin">
							<gml:pos>250000 920000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NC52.asc</gml:fileReference><!-- URI -->

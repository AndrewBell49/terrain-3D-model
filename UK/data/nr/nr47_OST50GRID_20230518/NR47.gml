		...
		<os:ElevationGridCoverage gml:id="os.t50.nr47.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nr47.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nr47.origin">
							<gml:pos>140000 670000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NR47.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nr67.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nr67.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nr67.origin">
							<gml:pos>160000 670000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NR67.asc</gml:fileReference><!-- URI -->

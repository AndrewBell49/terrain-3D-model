		...
		<os:ElevationGridCoverage gml:id="os.t50.nr93.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nr93.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nr93.origin">
							<gml:pos>190000 630000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NR93.asc</gml:fileReference><!-- URI -->

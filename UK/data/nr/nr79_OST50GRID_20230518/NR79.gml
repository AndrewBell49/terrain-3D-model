		...
		<os:ElevationGridCoverage gml:id="os.t50.nr79.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nr79.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nr79.origin">
							<gml:pos>170000 690000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NR79.asc</gml:fileReference><!-- URI -->

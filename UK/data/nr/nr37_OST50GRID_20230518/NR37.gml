		...
		<os:ElevationGridCoverage gml:id="os.t50.nr37.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nr37.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nr37.origin">
							<gml:pos>130000 670000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NR37.asc</gml:fileReference><!-- URI -->

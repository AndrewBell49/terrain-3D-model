		...
		<os:ElevationGridCoverage gml:id="os.t50.nr51.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nr51.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nr51.origin">
							<gml:pos>150000 610000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NR51.asc</gml:fileReference><!-- URI -->

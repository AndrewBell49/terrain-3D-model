		...
		<os:ElevationGridCoverage gml:id="os.t50.tl40.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tl40.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tl40.origin">
							<gml:pos>540000 200000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TL40.asc</gml:fileReference><!-- URI -->

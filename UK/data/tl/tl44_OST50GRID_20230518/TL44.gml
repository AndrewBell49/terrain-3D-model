		...
		<os:ElevationGridCoverage gml:id="os.t50.tl44.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tl44.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tl44.origin">
							<gml:pos>540000 240000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TL44.asc</gml:fileReference><!-- URI -->

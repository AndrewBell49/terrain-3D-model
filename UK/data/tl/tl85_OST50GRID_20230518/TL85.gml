		...
		<os:ElevationGridCoverage gml:id="os.t50.tl85.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tl85.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tl85.origin">
							<gml:pos>580000 250000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TL85.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tl35.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tl35.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tl35.origin">
							<gml:pos>530000 250000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TL35.asc</gml:fileReference><!-- URI -->

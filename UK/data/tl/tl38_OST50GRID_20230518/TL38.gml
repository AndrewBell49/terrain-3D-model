		...
		<os:ElevationGridCoverage gml:id="os.t50.tl38.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tl38.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tl38.origin">
							<gml:pos>530000 280000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TL38.asc</gml:fileReference><!-- URI -->

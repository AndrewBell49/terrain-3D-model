		...
		<os:ElevationGridCoverage gml:id="os.t50.tl82.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tl82.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tl82.origin">
							<gml:pos>580000 220000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TL82.asc</gml:fileReference><!-- URI -->

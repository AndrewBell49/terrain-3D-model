		...
		<os:ElevationGridCoverage gml:id="os.t50.tl08.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tl08.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tl08.origin">
							<gml:pos>500000 280000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TL08.asc</gml:fileReference><!-- URI -->

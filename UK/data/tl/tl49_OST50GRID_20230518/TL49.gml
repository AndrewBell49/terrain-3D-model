		...
		<os:ElevationGridCoverage gml:id="os.t50.tl49.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tl49.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tl49.origin">
							<gml:pos>540000 290000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TL49.asc</gml:fileReference><!-- URI -->

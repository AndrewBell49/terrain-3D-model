		...
		<os:ElevationGridCoverage gml:id="os.t50.tl04.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tl04.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tl04.origin">
							<gml:pos>500000 240000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TL04.asc</gml:fileReference><!-- URI -->

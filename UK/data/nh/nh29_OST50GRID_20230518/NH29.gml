		...
		<os:ElevationGridCoverage gml:id="os.t50.nh29.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nh29.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nh29.origin">
							<gml:pos>220000 890000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NH29.asc</gml:fileReference><!-- URI -->

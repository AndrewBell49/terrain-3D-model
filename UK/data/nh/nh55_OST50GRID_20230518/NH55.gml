		...
		<os:ElevationGridCoverage gml:id="os.t50.nh55.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nh55.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nh55.origin">
							<gml:pos>250000 850000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NH55.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nh82.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nh82.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nh82.origin">
							<gml:pos>280000 820000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NH82.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nh24.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nh24.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nh24.origin">
							<gml:pos>220000 840000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NH24.asc</gml:fileReference><!-- URI -->

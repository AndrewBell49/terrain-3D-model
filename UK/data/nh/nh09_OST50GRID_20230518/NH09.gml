		...
		<os:ElevationGridCoverage gml:id="os.t50.nh09.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nh09.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nh09.origin">
							<gml:pos>200000 890000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NH09.asc</gml:fileReference><!-- URI -->

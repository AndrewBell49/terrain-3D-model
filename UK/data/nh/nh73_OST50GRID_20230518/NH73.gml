		...
		<os:ElevationGridCoverage gml:id="os.t50.nh73.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nh73.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nh73.origin">
							<gml:pos>270000 830000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NH73.asc</gml:fileReference><!-- URI -->

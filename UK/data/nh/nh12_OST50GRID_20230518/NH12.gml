		...
		<os:ElevationGridCoverage gml:id="os.t50.nh12.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nh12.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nh12.origin">
							<gml:pos>210000 820000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NH12.asc</gml:fileReference><!-- URI -->

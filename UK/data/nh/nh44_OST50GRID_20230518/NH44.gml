		...
		<os:ElevationGridCoverage gml:id="os.t50.nh44.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nh44.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nh44.origin">
							<gml:pos>240000 840000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NH44.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nj11.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nj11.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nj11.origin">
							<gml:pos>310000 810000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NJ11.asc</gml:fileReference><!-- URI -->

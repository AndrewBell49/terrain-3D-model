		...
		<os:ElevationGridCoverage gml:id="os.t50.nj53.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nj53.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nj53.origin">
							<gml:pos>350000 830000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NJ53.asc</gml:fileReference><!-- URI -->

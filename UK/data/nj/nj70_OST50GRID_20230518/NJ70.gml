		...
		<os:ElevationGridCoverage gml:id="os.t50.nj70.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nj70.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nj70.origin">
							<gml:pos>370000 800000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NJ70.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nj62.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nj62.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nj62.origin">
							<gml:pos>360000 820000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NJ62.asc</gml:fileReference><!-- URI -->

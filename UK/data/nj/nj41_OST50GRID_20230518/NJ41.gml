		...
		<os:ElevationGridCoverage gml:id="os.t50.nj41.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nj41.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nj41.origin">
							<gml:pos>340000 810000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NJ41.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tq94.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq94.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq94.origin">
							<gml:pos>590000 140000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ94.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.tq13.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq13.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq13.origin">
							<gml:pos>510000 130000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ13.asc</gml:fileReference><!-- URI -->

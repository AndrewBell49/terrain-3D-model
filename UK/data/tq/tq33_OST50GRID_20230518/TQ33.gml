		...
		<os:ElevationGridCoverage gml:id="os.t50.tq33.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq33.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq33.origin">
							<gml:pos>530000 130000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ33.asc</gml:fileReference><!-- URI -->

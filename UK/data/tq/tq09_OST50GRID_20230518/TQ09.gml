		...
		<os:ElevationGridCoverage gml:id="os.t50.tq09.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq09.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq09.origin">
							<gml:pos>500000 190000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ09.asc</gml:fileReference><!-- URI -->

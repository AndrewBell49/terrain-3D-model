		...
		<os:ElevationGridCoverage gml:id="os.t50.tq44.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq44.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq44.origin">
							<gml:pos>540000 140000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ44.asc</gml:fileReference><!-- URI -->

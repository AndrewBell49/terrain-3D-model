		...
		<os:ElevationGridCoverage gml:id="os.t50.tq70.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq70.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq70.origin">
							<gml:pos>570000 100000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ70.asc</gml:fileReference><!-- URI -->

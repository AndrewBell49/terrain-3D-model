		...
		<os:ElevationGridCoverage gml:id="os.t50.tq96.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq96.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq96.origin">
							<gml:pos>590000 160000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ96.asc</gml:fileReference><!-- URI -->

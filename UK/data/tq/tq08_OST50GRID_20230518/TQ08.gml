		...
		<os:ElevationGridCoverage gml:id="os.t50.tq08.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.tq08.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.tq08.origin">
							<gml:pos>500000 180000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>TQ08.asc</gml:fileReference><!-- URI -->

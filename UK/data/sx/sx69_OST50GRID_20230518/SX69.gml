		...
		<os:ElevationGridCoverage gml:id="os.t50.sx69.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sx69.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sx69.origin">
							<gml:pos>260000 90000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SX69.asc</gml:fileReference><!-- URI -->

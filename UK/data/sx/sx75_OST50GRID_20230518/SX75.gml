		...
		<os:ElevationGridCoverage gml:id="os.t50.sx75.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sx75.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sx75.origin">
							<gml:pos>270000 50000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SX75.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sx18.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sx18.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sx18.origin">
							<gml:pos>210000 80000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SX18.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sx65.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sx65.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sx65.origin">
							<gml:pos>260000 50000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SX65.asc</gml:fileReference><!-- URI -->

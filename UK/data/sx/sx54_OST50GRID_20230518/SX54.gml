		...
		<os:ElevationGridCoverage gml:id="os.t50.sx54.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sx54.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sx54.origin">
							<gml:pos>250000 40000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SX54.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.so41.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so41.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so41.origin">
							<gml:pos>340000 210000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO41.asc</gml:fileReference><!-- URI -->

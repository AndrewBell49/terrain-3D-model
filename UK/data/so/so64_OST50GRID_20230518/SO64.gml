		...
		<os:ElevationGridCoverage gml:id="os.t50.so64.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so64.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so64.origin">
							<gml:pos>360000 240000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO64.asc</gml:fileReference><!-- URI -->

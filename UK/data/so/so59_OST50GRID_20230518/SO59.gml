		...
		<os:ElevationGridCoverage gml:id="os.t50.so59.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so59.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so59.origin">
							<gml:pos>350000 290000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO59.asc</gml:fileReference><!-- URI -->

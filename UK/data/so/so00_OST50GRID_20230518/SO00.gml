		...
		<os:ElevationGridCoverage gml:id="os.t50.so00.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so00.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so00.origin">
							<gml:pos>300000 200000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO00.asc</gml:fileReference><!-- URI -->

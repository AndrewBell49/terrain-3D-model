		...
		<os:ElevationGridCoverage gml:id="os.t50.so49.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so49.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so49.origin">
							<gml:pos>340000 290000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO49.asc</gml:fileReference><!-- URI -->

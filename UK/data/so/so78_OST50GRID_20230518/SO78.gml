		...
		<os:ElevationGridCoverage gml:id="os.t50.so78.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so78.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so78.origin">
							<gml:pos>370000 280000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO78.asc</gml:fileReference><!-- URI -->

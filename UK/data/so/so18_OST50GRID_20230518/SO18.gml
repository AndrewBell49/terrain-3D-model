		...
		<os:ElevationGridCoverage gml:id="os.t50.so18.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so18.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so18.origin">
							<gml:pos>310000 280000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO18.asc</gml:fileReference><!-- URI -->

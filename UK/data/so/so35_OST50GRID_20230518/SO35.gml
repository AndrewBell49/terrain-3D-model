		...
		<os:ElevationGridCoverage gml:id="os.t50.so35.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so35.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so35.origin">
							<gml:pos>330000 250000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO35.asc</gml:fileReference><!-- URI -->

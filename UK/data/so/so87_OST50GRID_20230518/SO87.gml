		...
		<os:ElevationGridCoverage gml:id="os.t50.so87.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so87.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so87.origin">
							<gml:pos>380000 270000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO87.asc</gml:fileReference><!-- URI -->

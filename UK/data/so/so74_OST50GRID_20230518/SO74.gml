		...
		<os:ElevationGridCoverage gml:id="os.t50.so74.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so74.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so74.origin">
							<gml:pos>370000 240000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO74.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.so81.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so81.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so81.origin">
							<gml:pos>380000 210000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO81.asc</gml:fileReference><!-- URI -->

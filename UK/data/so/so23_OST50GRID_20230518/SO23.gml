		...
		<os:ElevationGridCoverage gml:id="os.t50.so23.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.so23.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.so23.origin">
							<gml:pos>320000 230000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SO23.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.st80.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st80.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st80.origin">
							<gml:pos>380000 100000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST80.asc</gml:fileReference><!-- URI -->

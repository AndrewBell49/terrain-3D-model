		...
		<os:ElevationGridCoverage gml:id="os.t50.st21.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st21.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st21.origin">
							<gml:pos>320000 110000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST21.asc</gml:fileReference><!-- URI -->

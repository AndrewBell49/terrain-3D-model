		...
		<os:ElevationGridCoverage gml:id="os.t50.st40.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st40.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st40.origin">
							<gml:pos>340000 100000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST40.asc</gml:fileReference><!-- URI -->

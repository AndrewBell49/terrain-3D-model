		...
		<os:ElevationGridCoverage gml:id="os.t50.st61.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st61.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st61.origin">
							<gml:pos>360000 110000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST61.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.st12.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st12.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st12.origin">
							<gml:pos>310000 120000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST12.asc</gml:fileReference><!-- URI -->

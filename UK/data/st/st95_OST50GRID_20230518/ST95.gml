		...
		<os:ElevationGridCoverage gml:id="os.t50.st95.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st95.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st95.origin">
							<gml:pos>390000 150000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST95.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.st13.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st13.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st13.origin">
							<gml:pos>310000 130000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST13.asc</gml:fileReference><!-- URI -->

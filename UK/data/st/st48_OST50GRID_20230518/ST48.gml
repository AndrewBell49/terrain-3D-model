		...
		<os:ElevationGridCoverage gml:id="os.t50.st48.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st48.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st48.origin">
							<gml:pos>340000 180000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST48.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.st86.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st86.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st86.origin">
							<gml:pos>380000 160000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST86.asc</gml:fileReference><!-- URI -->

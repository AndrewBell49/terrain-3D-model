		...
		<os:ElevationGridCoverage gml:id="os.t50.st84.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st84.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st84.origin">
							<gml:pos>380000 140000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST84.asc</gml:fileReference><!-- URI -->

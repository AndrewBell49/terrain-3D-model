		...
		<os:ElevationGridCoverage gml:id="os.t50.st83.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st83.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st83.origin">
							<gml:pos>380000 130000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST83.asc</gml:fileReference><!-- URI -->

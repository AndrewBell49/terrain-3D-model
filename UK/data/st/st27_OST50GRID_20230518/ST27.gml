		...
		<os:ElevationGridCoverage gml:id="os.t50.st27.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.st27.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.st27.origin">
							<gml:pos>320000 170000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ST27.asc</gml:fileReference><!-- URI -->

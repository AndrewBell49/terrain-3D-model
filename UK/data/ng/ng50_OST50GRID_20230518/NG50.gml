		...
		<os:ElevationGridCoverage gml:id="os.t50.ng50.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ng50.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ng50.origin">
							<gml:pos>150000 800000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NG50.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.ng08.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ng08.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ng08.origin">
							<gml:pos>100000 880000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NG08.asc</gml:fileReference><!-- URI -->

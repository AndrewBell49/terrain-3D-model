		...
		<os:ElevationGridCoverage gml:id="os.t50.ng54.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ng54.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ng54.origin">
							<gml:pos>150000 840000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NG54.asc</gml:fileReference><!-- URI -->

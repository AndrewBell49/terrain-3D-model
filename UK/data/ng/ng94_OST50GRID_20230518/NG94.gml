		...
		<os:ElevationGridCoverage gml:id="os.t50.ng94.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ng94.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ng94.origin">
							<gml:pos>190000 840000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NG94.asc</gml:fileReference><!-- URI -->

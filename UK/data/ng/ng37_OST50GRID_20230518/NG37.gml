		...
		<os:ElevationGridCoverage gml:id="os.t50.ng37.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ng37.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ng37.origin">
							<gml:pos>130000 870000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NG37.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.ng99.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ng99.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ng99.origin">
							<gml:pos>190000 890000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NG99.asc</gml:fileReference><!-- URI -->

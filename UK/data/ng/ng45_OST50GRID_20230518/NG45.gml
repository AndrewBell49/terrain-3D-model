		...
		<os:ElevationGridCoverage gml:id="os.t50.ng45.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ng45.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ng45.origin">
							<gml:pos>140000 850000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NG45.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.ng83.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ng83.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ng83.origin">
							<gml:pos>180000 830000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NG83.asc</gml:fileReference><!-- URI -->

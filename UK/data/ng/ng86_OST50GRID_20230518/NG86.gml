		...
		<os:ElevationGridCoverage gml:id="os.t50.ng86.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ng86.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ng86.origin">
							<gml:pos>180000 860000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NG86.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sd99.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd99.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd99.origin">
							<gml:pos>390000 490000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD99.asc</gml:fileReference><!-- URI -->

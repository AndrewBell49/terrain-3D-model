		...
		<os:ElevationGridCoverage gml:id="os.t50.sd09.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd09.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd09.origin">
							<gml:pos>300000 490000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD09.asc</gml:fileReference><!-- URI -->

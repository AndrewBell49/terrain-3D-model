		...
		<os:ElevationGridCoverage gml:id="os.t50.sd40.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd40.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd40.origin">
							<gml:pos>340000 400000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD40.asc</gml:fileReference><!-- URI -->

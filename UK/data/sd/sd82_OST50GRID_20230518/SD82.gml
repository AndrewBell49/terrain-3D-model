		...
		<os:ElevationGridCoverage gml:id="os.t50.sd82.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd82.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd82.origin">
							<gml:pos>380000 420000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD82.asc</gml:fileReference><!-- URI -->

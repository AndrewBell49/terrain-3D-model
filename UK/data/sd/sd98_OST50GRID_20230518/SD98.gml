		...
		<os:ElevationGridCoverage gml:id="os.t50.sd98.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd98.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd98.origin">
							<gml:pos>390000 480000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD98.asc</gml:fileReference><!-- URI -->

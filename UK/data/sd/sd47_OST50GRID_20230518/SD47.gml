		...
		<os:ElevationGridCoverage gml:id="os.t50.sd47.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd47.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd47.origin">
							<gml:pos>340000 470000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD47.asc</gml:fileReference><!-- URI -->

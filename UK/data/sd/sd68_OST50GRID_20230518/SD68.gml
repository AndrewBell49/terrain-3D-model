		...
		<os:ElevationGridCoverage gml:id="os.t50.sd68.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd68.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd68.origin">
							<gml:pos>360000 480000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD68.asc</gml:fileReference><!-- URI -->

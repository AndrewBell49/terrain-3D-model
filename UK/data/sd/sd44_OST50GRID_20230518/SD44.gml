		...
		<os:ElevationGridCoverage gml:id="os.t50.sd44.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd44.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd44.origin">
							<gml:pos>340000 440000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD44.asc</gml:fileReference><!-- URI -->

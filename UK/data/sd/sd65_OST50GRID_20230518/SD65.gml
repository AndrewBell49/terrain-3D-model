		...
		<os:ElevationGridCoverage gml:id="os.t50.sd65.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd65.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd65.origin">
							<gml:pos>360000 450000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD65.asc</gml:fileReference><!-- URI -->

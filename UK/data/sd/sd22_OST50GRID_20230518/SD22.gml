		...
		<os:ElevationGridCoverage gml:id="os.t50.sd22.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sd22.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sd22.origin">
							<gml:pos>320000 420000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SD22.asc</gml:fileReference><!-- URI -->

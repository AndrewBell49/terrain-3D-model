		...
		<os:ElevationGridCoverage gml:id="os.t50.nt92.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt92.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt92.origin">
							<gml:pos>390000 620000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT92.asc</gml:fileReference><!-- URI -->

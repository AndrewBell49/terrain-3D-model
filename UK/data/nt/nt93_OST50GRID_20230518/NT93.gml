		...
		<os:ElevationGridCoverage gml:id="os.t50.nt93.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt93.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt93.origin">
							<gml:pos>390000 630000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT93.asc</gml:fileReference><!-- URI -->

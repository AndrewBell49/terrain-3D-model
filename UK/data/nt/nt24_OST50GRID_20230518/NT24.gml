		...
		<os:ElevationGridCoverage gml:id="os.t50.nt24.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt24.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt24.origin">
							<gml:pos>320000 640000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT24.asc</gml:fileReference><!-- URI -->

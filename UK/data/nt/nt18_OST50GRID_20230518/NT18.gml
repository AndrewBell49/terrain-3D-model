		...
		<os:ElevationGridCoverage gml:id="os.t50.nt18.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt18.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt18.origin">
							<gml:pos>310000 680000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT18.asc</gml:fileReference><!-- URI -->

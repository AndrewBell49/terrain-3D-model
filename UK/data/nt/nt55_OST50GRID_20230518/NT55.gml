		...
		<os:ElevationGridCoverage gml:id="os.t50.nt55.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt55.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt55.origin">
							<gml:pos>350000 650000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT55.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nt86.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt86.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt86.origin">
							<gml:pos>380000 660000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT86.asc</gml:fileReference><!-- URI -->

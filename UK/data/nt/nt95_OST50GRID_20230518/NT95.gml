		...
		<os:ElevationGridCoverage gml:id="os.t50.nt95.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt95.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt95.origin">
							<gml:pos>390000 650000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT95.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nt09.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt09.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt09.origin">
							<gml:pos>300000 690000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT09.asc</gml:fileReference><!-- URI -->

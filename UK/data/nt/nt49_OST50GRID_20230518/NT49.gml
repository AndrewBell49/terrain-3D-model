		...
		<os:ElevationGridCoverage gml:id="os.t50.nt49.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt49.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt49.origin">
							<gml:pos>340000 690000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT49.asc</gml:fileReference><!-- URI -->

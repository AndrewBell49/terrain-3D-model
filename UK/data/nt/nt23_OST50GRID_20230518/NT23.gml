		...
		<os:ElevationGridCoverage gml:id="os.t50.nt23.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt23.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt23.origin">
							<gml:pos>320000 630000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT23.asc</gml:fileReference><!-- URI -->

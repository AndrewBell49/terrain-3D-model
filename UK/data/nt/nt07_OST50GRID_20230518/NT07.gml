		...
		<os:ElevationGridCoverage gml:id="os.t50.nt07.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt07.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt07.origin">
							<gml:pos>300000 670000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT07.asc</gml:fileReference><!-- URI -->

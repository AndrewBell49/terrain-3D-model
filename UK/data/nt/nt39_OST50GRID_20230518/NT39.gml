		...
		<os:ElevationGridCoverage gml:id="os.t50.nt39.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt39.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt39.origin">
							<gml:pos>330000 690000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT39.asc</gml:fileReference><!-- URI -->

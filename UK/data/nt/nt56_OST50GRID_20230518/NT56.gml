		...
		<os:ElevationGridCoverage gml:id="os.t50.nt56.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt56.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt56.origin">
							<gml:pos>350000 660000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT56.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nt47.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nt47.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nt47.origin">
							<gml:pos>340000 670000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NT47.asc</gml:fileReference><!-- URI -->

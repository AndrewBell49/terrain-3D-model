		...
		<os:ElevationGridCoverage gml:id="os.t50.hw63.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hw63.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hw63.origin">
							<gml:pos>160000 1030000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HW63.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.hu68.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hu68.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hu68.origin">
							<gml:pos>460000 1180000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HU68.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.hu57.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hu57.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hu57.origin">
							<gml:pos>450000 1170000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HU57.asc</gml:fileReference><!-- URI -->

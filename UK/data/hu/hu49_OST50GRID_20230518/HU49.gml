		...
		<os:ElevationGridCoverage gml:id="os.t50.hu49.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hu49.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hu49.origin">
							<gml:pos>440000 1190000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HU49.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.hu27.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hu27.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hu27.origin">
							<gml:pos>420000 1170000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HU27.asc</gml:fileReference><!-- URI -->

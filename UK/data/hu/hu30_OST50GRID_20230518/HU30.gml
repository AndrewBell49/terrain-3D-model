		...
		<os:ElevationGridCoverage gml:id="os.t50.hu30.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hu30.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hu30.origin">
							<gml:pos>430000 1100000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HU30.asc</gml:fileReference><!-- URI -->

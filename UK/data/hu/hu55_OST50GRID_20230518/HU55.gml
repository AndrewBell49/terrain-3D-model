		...
		<os:ElevationGridCoverage gml:id="os.t50.hu55.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hu55.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hu55.origin">
							<gml:pos>450000 1150000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HU55.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.hu77.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hu77.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hu77.origin">
							<gml:pos>470000 1170000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HU77.asc</gml:fileReference><!-- URI -->

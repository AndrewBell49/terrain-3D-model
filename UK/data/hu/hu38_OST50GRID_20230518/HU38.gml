		...
		<os:ElevationGridCoverage gml:id="os.t50.hu38.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hu38.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hu38.origin">
							<gml:pos>430000 1180000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HU38.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.ny96.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ny96.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ny96.origin">
							<gml:pos>390000 560000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NY96.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.ny45.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ny45.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ny45.origin">
							<gml:pos>340000 550000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NY45.asc</gml:fileReference><!-- URI -->

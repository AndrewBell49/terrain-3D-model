		...
		<os:ElevationGridCoverage gml:id="os.t50.ny46.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ny46.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ny46.origin">
							<gml:pos>340000 560000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NY46.asc</gml:fileReference><!-- URI -->

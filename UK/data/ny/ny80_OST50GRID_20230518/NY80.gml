		...
		<os:ElevationGridCoverage gml:id="os.t50.ny80.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ny80.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ny80.origin">
							<gml:pos>380000 500000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NY80.asc</gml:fileReference><!-- URI -->

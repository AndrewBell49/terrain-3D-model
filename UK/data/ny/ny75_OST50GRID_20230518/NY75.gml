		...
		<os:ElevationGridCoverage gml:id="os.t50.ny75.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ny75.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ny75.origin">
							<gml:pos>370000 550000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NY75.asc</gml:fileReference><!-- URI -->

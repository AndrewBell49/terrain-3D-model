		...
		<os:ElevationGridCoverage gml:id="os.t50.ny05.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ny05.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ny05.origin">
							<gml:pos>300000 550000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NY05.asc</gml:fileReference><!-- URI -->

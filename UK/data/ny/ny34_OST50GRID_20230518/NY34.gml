		...
		<os:ElevationGridCoverage gml:id="os.t50.ny34.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ny34.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ny34.origin">
							<gml:pos>330000 540000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NY34.asc</gml:fileReference><!-- URI -->

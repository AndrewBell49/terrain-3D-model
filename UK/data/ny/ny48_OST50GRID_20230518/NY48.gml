		...
		<os:ElevationGridCoverage gml:id="os.t50.ny48.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ny48.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ny48.origin">
							<gml:pos>340000 580000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NY48.asc</gml:fileReference><!-- URI -->

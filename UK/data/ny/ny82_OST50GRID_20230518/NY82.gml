		...
		<os:ElevationGridCoverage gml:id="os.t50.ny82.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ny82.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ny82.origin">
							<gml:pos>380000 520000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NY82.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.ny15.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ny15.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ny15.origin">
							<gml:pos>310000 550000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NY15.asc</gml:fileReference><!-- URI -->

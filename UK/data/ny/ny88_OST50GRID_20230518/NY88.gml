		...
		<os:ElevationGridCoverage gml:id="os.t50.ny88.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ny88.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ny88.origin">
							<gml:pos>380000 580000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NY88.asc</gml:fileReference><!-- URI -->

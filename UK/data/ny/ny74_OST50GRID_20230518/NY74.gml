		...
		<os:ElevationGridCoverage gml:id="os.t50.ny74.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ny74.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ny74.origin">
							<gml:pos>370000 540000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NY74.asc</gml:fileReference><!-- URI -->

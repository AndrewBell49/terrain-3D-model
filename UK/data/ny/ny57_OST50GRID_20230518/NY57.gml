		...
		<os:ElevationGridCoverage gml:id="os.t50.ny57.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ny57.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ny57.origin">
							<gml:pos>350000 570000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NY57.asc</gml:fileReference><!-- URI -->

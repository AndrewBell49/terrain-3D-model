		...
		<os:ElevationGridCoverage gml:id="os.t50.nm57.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm57.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm57.origin">
							<gml:pos>150000 770000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM57.asc</gml:fileReference><!-- URI -->

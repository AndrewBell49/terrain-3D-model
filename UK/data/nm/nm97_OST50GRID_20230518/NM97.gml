		...
		<os:ElevationGridCoverage gml:id="os.t50.nm97.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm97.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm97.origin">
							<gml:pos>190000 770000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM97.asc</gml:fileReference><!-- URI -->

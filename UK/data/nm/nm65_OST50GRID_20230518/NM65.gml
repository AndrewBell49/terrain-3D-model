		...
		<os:ElevationGridCoverage gml:id="os.t50.nm65.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm65.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm65.origin">
							<gml:pos>160000 750000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM65.asc</gml:fileReference><!-- URI -->

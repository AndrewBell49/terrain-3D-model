		...
		<os:ElevationGridCoverage gml:id="os.t50.nm83.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm83.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm83.origin">
							<gml:pos>180000 730000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM83.asc</gml:fileReference><!-- URI -->

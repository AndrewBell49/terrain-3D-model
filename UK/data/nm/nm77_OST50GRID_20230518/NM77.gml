		...
		<os:ElevationGridCoverage gml:id="os.t50.nm77.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm77.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm77.origin">
							<gml:pos>170000 770000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM77.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nm05.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm05.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm05.origin">
							<gml:pos>100000 750000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM05.asc</gml:fileReference><!-- URI -->

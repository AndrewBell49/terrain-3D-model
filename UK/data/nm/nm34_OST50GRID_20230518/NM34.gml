		...
		<os:ElevationGridCoverage gml:id="os.t50.nm34.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm34.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm34.origin">
							<gml:pos>130000 740000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM34.asc</gml:fileReference><!-- URI -->

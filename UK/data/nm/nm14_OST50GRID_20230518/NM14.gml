		...
		<os:ElevationGridCoverage gml:id="os.t50.nm14.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm14.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm14.origin">
							<gml:pos>110000 740000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM14.asc</gml:fileReference><!-- URI -->

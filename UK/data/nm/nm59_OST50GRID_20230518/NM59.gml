		...
		<os:ElevationGridCoverage gml:id="os.t50.nm59.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm59.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm59.origin">
							<gml:pos>150000 790000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM59.asc</gml:fileReference><!-- URI -->

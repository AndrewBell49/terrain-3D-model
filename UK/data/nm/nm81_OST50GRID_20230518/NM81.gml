		...
		<os:ElevationGridCoverage gml:id="os.t50.nm81.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm81.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm81.origin">
							<gml:pos>180000 710000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM81.asc</gml:fileReference><!-- URI -->

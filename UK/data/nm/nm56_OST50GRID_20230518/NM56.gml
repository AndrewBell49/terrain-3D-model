		...
		<os:ElevationGridCoverage gml:id="os.t50.nm56.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nm56.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nm56.origin">
							<gml:pos>150000 760000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NM56.asc</gml:fileReference><!-- URI -->

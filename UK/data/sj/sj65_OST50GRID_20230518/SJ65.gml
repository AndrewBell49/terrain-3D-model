		...
		<os:ElevationGridCoverage gml:id="os.t50.sj65.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj65.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj65.origin">
							<gml:pos>360000 350000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ65.asc</gml:fileReference><!-- URI -->

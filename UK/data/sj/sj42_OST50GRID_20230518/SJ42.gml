		...
		<os:ElevationGridCoverage gml:id="os.t50.sj42.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj42.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj42.origin">
							<gml:pos>340000 320000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ42.asc</gml:fileReference><!-- URI -->

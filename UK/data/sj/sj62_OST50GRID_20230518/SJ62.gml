		...
		<os:ElevationGridCoverage gml:id="os.t50.sj62.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj62.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj62.origin">
							<gml:pos>360000 320000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ62.asc</gml:fileReference><!-- URI -->

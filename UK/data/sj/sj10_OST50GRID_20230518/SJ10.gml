		...
		<os:ElevationGridCoverage gml:id="os.t50.sj10.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj10.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj10.origin">
							<gml:pos>310000 300000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ10.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sj69.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj69.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj69.origin">
							<gml:pos>360000 390000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ69.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sj75.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj75.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj75.origin">
							<gml:pos>370000 350000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ75.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.sj99.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj99.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj99.origin">
							<gml:pos>390000 390000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ99.asc</gml:fileReference><!-- URI -->

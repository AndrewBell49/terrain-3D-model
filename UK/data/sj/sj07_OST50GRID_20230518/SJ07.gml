		...
		<os:ElevationGridCoverage gml:id="os.t50.sj07.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj07.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj07.origin">
							<gml:pos>300000 370000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ07.asc</gml:fileReference><!-- URI -->

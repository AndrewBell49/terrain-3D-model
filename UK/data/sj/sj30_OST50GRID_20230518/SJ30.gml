		...
		<os:ElevationGridCoverage gml:id="os.t50.sj30.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj30.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj30.origin">
							<gml:pos>330000 300000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ30.asc</gml:fileReference><!-- URI -->

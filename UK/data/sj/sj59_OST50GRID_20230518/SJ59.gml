		...
		<os:ElevationGridCoverage gml:id="os.t50.sj59.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj59.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj59.origin">
							<gml:pos>350000 390000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ59.asc</gml:fileReference><!-- URI -->

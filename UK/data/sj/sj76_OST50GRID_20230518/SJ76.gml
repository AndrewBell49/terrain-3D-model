		...
		<os:ElevationGridCoverage gml:id="os.t50.sj76.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj76.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj76.origin">
							<gml:pos>370000 360000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ76.asc</gml:fileReference><!-- URI -->

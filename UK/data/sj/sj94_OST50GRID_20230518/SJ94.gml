		...
		<os:ElevationGridCoverage gml:id="os.t50.sj94.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj94.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj94.origin">
							<gml:pos>390000 340000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ94.asc</gml:fileReference><!-- URI -->

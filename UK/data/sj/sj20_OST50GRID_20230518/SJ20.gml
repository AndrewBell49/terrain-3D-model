		...
		<os:ElevationGridCoverage gml:id="os.t50.sj20.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj20.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj20.origin">
							<gml:pos>320000 300000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ20.asc</gml:fileReference><!-- URI -->

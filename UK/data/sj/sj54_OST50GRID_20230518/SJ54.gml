		...
		<os:ElevationGridCoverage gml:id="os.t50.sj54.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj54.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj54.origin">
							<gml:pos>350000 340000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ54.asc</gml:fileReference><!-- URI -->

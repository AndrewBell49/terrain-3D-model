		...
		<os:ElevationGridCoverage gml:id="os.t50.sj90.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sj90.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sj90.origin">
							<gml:pos>390000 300000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SJ90.asc</gml:fileReference><!-- URI -->

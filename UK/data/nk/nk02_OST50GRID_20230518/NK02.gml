		...
		<os:ElevationGridCoverage gml:id="os.t50.nk02.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nk02.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nk02.origin">
							<gml:pos>400000 820000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NK02.asc</gml:fileReference><!-- URI -->

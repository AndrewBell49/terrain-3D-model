		...
		<os:ElevationGridCoverage gml:id="os.t50.hp40.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.hp40.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.hp40.origin">
							<gml:pos>440000 1200000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>HP40.asc</gml:fileReference><!-- URI -->

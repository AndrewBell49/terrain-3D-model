		...
		<os:ElevationGridCoverage gml:id="os.t50.sv81.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.sv81.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.sv81.origin">
							<gml:pos>80000 10000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SV81.asc</gml:fileReference><!-- URI -->

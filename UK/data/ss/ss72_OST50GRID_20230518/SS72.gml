		...
		<os:ElevationGridCoverage gml:id="os.t50.ss72.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ss72.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ss72.origin">
							<gml:pos>270000 120000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SS72.asc</gml:fileReference><!-- URI -->

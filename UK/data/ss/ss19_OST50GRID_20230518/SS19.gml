		...
		<os:ElevationGridCoverage gml:id="os.t50.ss19.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ss19.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ss19.origin">
							<gml:pos>210000 190000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SS19.asc</gml:fileReference><!-- URI -->

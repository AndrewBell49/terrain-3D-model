		...
		<os:ElevationGridCoverage gml:id="os.t50.ss79.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ss79.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ss79.origin">
							<gml:pos>270000 190000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SS79.asc</gml:fileReference><!-- URI -->

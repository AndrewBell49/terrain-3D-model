		...
		<os:ElevationGridCoverage gml:id="os.t50.ss22.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ss22.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ss22.origin">
							<gml:pos>220000 120000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SS22.asc</gml:fileReference><!-- URI -->

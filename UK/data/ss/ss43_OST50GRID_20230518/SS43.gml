		...
		<os:ElevationGridCoverage gml:id="os.t50.ss43.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ss43.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ss43.origin">
							<gml:pos>240000 130000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SS43.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.ss60.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.ss60.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.ss60.origin">
							<gml:pos>260000 100000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>SS60.asc</gml:fileReference><!-- URI -->

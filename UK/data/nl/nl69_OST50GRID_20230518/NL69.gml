		...
		<os:ElevationGridCoverage gml:id="os.t50.nl69.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nl69.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nl69.origin">
							<gml:pos>60000 790000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NL69.asc</gml:fileReference><!-- URI -->

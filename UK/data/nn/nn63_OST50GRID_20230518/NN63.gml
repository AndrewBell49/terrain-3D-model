		...
		<os:ElevationGridCoverage gml:id="os.t50.nn63.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nn63.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nn63.origin">
							<gml:pos>260000 730000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NN63.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nd36.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nd36.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nd36.origin">
							<gml:pos>330000 960000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ND36.asc</gml:fileReference><!-- URI -->

		...
		<os:ElevationGridCoverage gml:id="os.t50.nd25.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nd25.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nd25.origin">
							<gml:pos>320000 950000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ND25.asc</gml:fileReference><!-- URI -->

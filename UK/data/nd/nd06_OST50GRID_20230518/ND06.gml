		...
		<os:ElevationGridCoverage gml:id="os.t50.nd06.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nd06.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nd06.origin">
							<gml:pos>300000 960000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ND06.asc</gml:fileReference><!-- URI -->

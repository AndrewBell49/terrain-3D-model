		...
		<os:ElevationGridCoverage gml:id="os.t50.nd47.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nd47.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nd47.origin">
							<gml:pos>340000 970000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>ND47.asc</gml:fileReference><!-- URI -->

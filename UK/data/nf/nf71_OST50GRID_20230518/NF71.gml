		...
		<os:ElevationGridCoverage gml:id="os.t50.nf71.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nf71.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nf71.origin">
							<gml:pos>70000 810000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NF71.asc</gml:fileReference><!-- URI -->

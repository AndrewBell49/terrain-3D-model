		...
		<os:ElevationGridCoverage gml:id="os.t50.nf84.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nf84.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nf84.origin">
							<gml:pos>80000 840000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NF84.asc</gml:fileReference><!-- URI -->

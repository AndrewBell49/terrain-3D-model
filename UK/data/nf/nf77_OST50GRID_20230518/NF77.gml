		...
		<os:ElevationGridCoverage gml:id="os.t50.nf77.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nf77.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nf77.origin">
							<gml:pos>70000 870000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NF77.asc</gml:fileReference><!-- URI -->

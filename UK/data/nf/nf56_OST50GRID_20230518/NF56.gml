		...
		<os:ElevationGridCoverage gml:id="os.t50.nf56.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nf56.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nf56.origin">
							<gml:pos>50000 860000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NF56.asc</gml:fileReference><!-- URI -->

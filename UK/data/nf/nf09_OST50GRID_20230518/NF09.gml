		...
		<os:ElevationGridCoverage gml:id="os.t50.nf09.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nf09.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nf09.origin">
							<gml:pos>0 890000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NF09.asc</gml:fileReference><!-- URI -->

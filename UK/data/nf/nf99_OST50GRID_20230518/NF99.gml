		...
		<os:ElevationGridCoverage gml:id="os.t50.nf99.elevgrid">
			<gml:rectifiedGridDomain>
				<gml:RectifiedGrid srsName="urn:ogc:def:crs:EPSG::27700" dimension="2" gml:id="os.t50.nf99.rectgrid">
					...
					<gml:origin>
						<gml:Point gml:id="os.t50.nf99.origin">
							<gml:pos>90000 890000</gml:pos>
						</gml:Point>
					</gml:origin>
			...
			<gml:rangeSet>
				<gml:File>
					...
					<gml:fileReference>NF99.asc</gml:fileReference><!-- URI -->
